...
public class WebserviceMethods {
	...
	public String serviceAuthURL = "http://fss-dapps1:"+getSerToProj()+"/security/authenticate/agent";
	...
	public String runAuthWebservice() throws Exception{
		...
		agntserv.setUsername("keypage");
		agntserv.setPassword("keypage");
		//agntserv.setAccuCode("PlanEmpower");
		//agntserv.setAccuAccessTypeCode("PSC");
		...
		Reporter.logEvent(Status.PASS, "Verify Authentication Code", "Authentication code has generated successfully", false);
		return authCode;
	}
	...
	public String runAdvServiceProfile(String requestUrl, String authCode) throws Exception {
		...
		if(httpGetResp.getStatusLine().getStatusCode() == Integer.parseInt("200"))
	...
	{
		String envName=Stock.getConfigParam("TEST_ENV").replace("-", "_");
		switch(envName)
		{
