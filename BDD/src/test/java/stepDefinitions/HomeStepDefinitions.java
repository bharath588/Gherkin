...
import pageobjects.psc.FileSharingPage;
...
public class HomeStepDefinitions {
	...
	public void user_is_on_Home_page_on_the_site(String accuCode) throws Throwable {
	...
	public void user_switches_to(String arg1) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		homePage = new HomePage(Web.getDriver());
		homePage.switchPlan(arg1);
	}
	...
	public void gwc_connect_page_is_displayed() throws Throwable {
		...
		if(homePage.isSalesForcePage()){
			Reporter.logEvent(Status.PASS, "User has landed on GWC connect page", 
					"User has landed on GWC connect page", true);
		}
		else{
			Reporter.logEvent(Status.FAIL, "User has landed on GWC connect page", 
	...
	public void username_is_displayed_on_the_top_right_hand_corner_of_the_site() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		Reporter.logEvent(Status.INFO, "This is unavailable for MN", "This is unavailable for MN", true);
	}
	...
	public void a_new_tab_opens_with_https_www_youtube_com_channel_UCFPLlGp_vPjBb_G_SnUWhQ(int arg1, int arg2) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^User clicks on the Instagram social media icon$")
	public void user_clicks_on_the_Instagram_social_media_icon() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^A new tab opens with https://www\\.instagram\\.com/empowerretirement/$")
	public void a_new_tab_opens_with_https_www_instagram_com_empowerretirement() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void user_is_on_home_page() throws Throwable {
		...
		homePage = new HomePage();
		homePage.get();
		Reporter.logEvent(Status.INFO, "User is on home page", "User is on home page", true);
	}
	...
	public void the_link_should_open_a_PDF_in_a_new_window() throws Throwable {
		...
		if(homePage.isTnCOpensInNewWindow()){
			Reporter.logEvent(Status.PASS, "Terms and Conditions link opens in a new window", 
					"Terms and Conditions link opens in a new window", true);
		}
		else{
			Reporter.logEvent(Status.FAIL, "Terms and Conditions link opens in a new window", 
					"Terms and Conditions link does not open in a new window", true);
		}
	}

	@When("^user clicks on Terms and Conditions link displayed in the footer on home page$")
	public void user_clicks_on_Terms_and_Conditions_link_displayed_in_the_footer_on_home_page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		homePage = new HomePage();
	...
	public void the_Terms_and_Conditions_link_should_not_be_displayed_in_the_footer_system_tray_on_home_page() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		homePage = new HomePage();
		if(homePage.isTnCDisplayedInSysTray()){
			Reporter.logEvent(Status.PASS, "Terms and conditions link does not display in system "
					+ "tray on home page", "Terms and conditions link does not display in system tray "
							+ "on home page", true);
		}
		else{
			Reporter.logEvent(Status.FAIL, "Terms and conditions link does not display in system "
					+ "tray on home page", "Terms and conditions link displays in system tray "
							+ "on home page", true);
		}
	...
	public void the_System_Requirements_content_should_be_displayed_in_a_pop_up_window() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		homePage = new HomePage();
	...
	public void user_is_on_the_Home_page_of_accuCode_when_user_login_with_correct_username_and_password(DataTable accAndCreds) throws Throwable {
		Reporter.initializeReportForTC(1,Globals.scenarioName);
	...
	public void user_is_on_the_Home_page_of_when_user_login_with_correct_and(String accuCode, String username, String password) throws Throwable {
	...
	public void the_copyright_date_should_be(String copyrightText) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		if(new HomePage().isCurrentYearDisplayedInCopyright(copyrightText))
			Reporter.logEvent(Status.PASS, "Current year displays in copyright", 
					"Current year displays in copyright", true);
		else
			Reporter.logEvent(Status.FAIL, "Current year displays in copyright", 
