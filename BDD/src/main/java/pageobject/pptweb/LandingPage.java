...
//		if (userFromDatasheet.equalsIgnoreCase(userLogedIn))*/if(Web.isWebElementDisplayed(lblUserName,true)) {
	 ...
	 * 
	 * //CommonLib.VerifyText(TestDataContainer.GetParameterValue("DailyBalance"),
	 * strDailyBal);
	 * CommonLib.VerifyText(TestDataContainer.GetParameterValue("DailyBalance"),
	 * strDailyBal);
	 * 
	 ...
	 * 
	 * CommonLib.VerifyText(TestDataContainer.GetParameterValue("RateOfReturn"),
	 * strRateOfReturn);
	 * 
	 * String strLastContributionAmount = LastContributionAmount.getText();
	 * 
	 * CommonLib.VerifyText(TestDataContainer.GetParameterValue(
