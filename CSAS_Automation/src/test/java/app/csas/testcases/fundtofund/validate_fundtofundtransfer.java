...
public class validate_fundtofundtransfer {
	...
	public void Validate_Fund_to_Fund_Confirm_Transfer(int itr,Map<String, String> testdata) {
		...
		try {
			...
			participantHomeObj.search_PPT_Plan_With_PPT_ID_OR_SSN("PPT_ID",Stock.GetParameterValue("PPT_ID"),Stock.GetParameterValue("GA_ID"));
			...
			fund2fund_Obj.EnterTransferFromFundVal(Stock.GetParameterValue("TransferFromVal"));
			
			// Step6: Enter Transfer to fund val
			fund2fund_Obj.EnterTransferToFundVal(Stock.GetParameterValue("TransferToVal"));
