...
public class PGSC_Edit_Snapshot_Criterion_Structure {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PGSC_Edit_Snapshot_Criterion_Structure";
	...
	String PRODUCT;
	String PUSNCR1_PROD_ID_LOV1_X1;
	String GA_hash_SNCR1_GA_ID_0;
	String GA_hash_SNCR1_GA_ID_LOV2;
	...
	public void setPUSNCR1_PROD_ID_LOV1_X1(String pUSNCR1_PROD_ID_LOV1_X1) {
		PUSNCR1_PROD_ID_LOV1_X1 = pUSNCR1_PROD_ID_LOV1_X1;
	}
	public void setGA_hash_SNCR1_GA_ID_0(String gA_hash_SNCR1_GA_ID_0) {
		GA_hash_SNCR1_GA_ID_0 = gA_hash_SNCR1_GA_ID_0;
	}
	public void setGA_hash_SNCR1_GA_ID_LOV2(String gA_hash_SNCR1_GA_ID_LOV2) {
		GA_hash_SNCR1_GA_ID_LOV2 = gA_hash_SNCR1_GA_ID_LOV2;
	}
	...
	public void setServiceParameters()	
	{
		...
		this.setGA_hash_SNCR1_GA_ID_0(Stock.GetParameterValue("GA_hash_SNCR1_GA_ID_0"));
		this.setGA_hash_SNCR1_GA_ID_LOV2(Stock.GetParameterValue("GA_hash_SNCR1_GA_ID_LOV2"));
		this.setPUSNCR1_PROD_ID_LOV1_X1(Stock.GetParameterValue("PUSNCR1_PROD_ID_LOV1_X1"));
		
		
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&SCSSIO1_SDIO_ID_0="+SCSSIO1_SDIO_ID_0+"&PUSNCR1_PROD_ID_LOV1="+PUSNCR1_PROD_ID_LOV1+"&PRODUCT="+PRODUCT+"&PUSNCR1_PROD_ID_LOV1_X1="+PUSNCR1_PROD_ID_LOV1_X1+
				"&GA_hash_SNCR1_GA_ID_0="+GA_hash_SNCR1_GA_ID_0+"&GA_hash_SNCR1_GA_ID_LOV2="+GA_hash_SNCR1_GA_ID_LOV2+"&SCSSMT1_SDMT_CODE_0="+SCSSMT1_SDMT_CODE_0+
