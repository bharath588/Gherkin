...
public class KWCN_Generate_Expanded_Compliance_Census_File {

	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/KWCN_Generate_Expanded_Compliance_Census_File";
	...
	public void setINP1_DISP_DFT_VALUE_4(String iNP1_DISP_DFT_VALUE_3) {
		INP1_DISP_DFT_VALUE_4 = iNP1_DISP_DFT_VALUE_3;
	}
	...
	public void setServiceParameters()	
	{
		...
		this.setINP1_DISP_DFT_VALUE_4(Stock.GetParameterValue("INP1_DISP_DFT_VALUE_4"));
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&INP1_DISP_DFT_VALUE_0="+INP1_DISP_DFT_VALUE_0+"&INP1_DISP_DFT_VALUE_1="+INP1_DISP_DFT_VALUE_1+"&INP1_DISP_DFT_VALUE_2="+INP1_DISP_DFT_VALUE_2+"&INP1_DISP_DFT_VALUE_3="+INP1_DISP_DFT_VALUE_3+"&INP1_DISP_DFT_VALUE_4="+INP1_DISP_DFT_VALUE_4+
