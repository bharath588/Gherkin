...
public class ACCU {
	...
	String a[]={"CONTROL_SELECTION_0","LOGON_DATABASE","LOGON_PASSWORD","LOGON_USERNAME"};
	
	public static void main(String[] args) {
		//initializeValues();
		OracleForms of=new OracleForms();
		//of.initializeParams("CONTROL_SELECTION_0","LOGON_DATABASE","LOGON_PASSWORD","LOGON_USERNAME");
	}
