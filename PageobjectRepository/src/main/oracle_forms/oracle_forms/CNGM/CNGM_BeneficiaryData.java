...
public class CNGM_BeneficiaryData {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CNGM_Validate_Conversion_Global_Mapping_Beneficiary_data";
	...
	public void setCHECKBOXES_BENES_0(String cHECKBOXES_BENES_0) {
		CHECKBOXES_BENES_0 = cHECKBOXES_BENES_0;
	}
	...
	public void setServiceParameters()	
	{
		...
		this.setCHECKBOXES_BENES_0(Stock.GetParameterValue("CHECKBOXES_BENES_0"));
		
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0="+CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0+"&CHECKBOXES_BENES_0="+CHECKBOXES_BENES_0+"&MO1_DISP_DFT_PRIN_CODE_0="+MO1_DISP_DFT_PRIN_CODE_0+
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCNGMBen")[1]);
