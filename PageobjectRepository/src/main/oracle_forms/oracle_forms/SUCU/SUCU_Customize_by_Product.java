...
public class SUCU_Customize_by_Product {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/SUCU_Customize_by_Product";
	...
	public void setSELECTION_PROD_ID_0(String sELECTION_PROD_ID_0){
		SELECTION_PROD_ID_0 = sELECTION_PROD_ID_0;
	}
	...
	public void setServiceParameters()
	{
		...
		this.setSELECTION_PROD_ID_0(Stock.GetParameterValue("SELECTION_PROD_ID_0"));
		...
		queryString = "?LOGON_USERNAME=" + LOGON_USERNAME + "&LOGON_PASSWORD=" + LOGON_PASSWORD + "&LOGON_DATABASE=" + LOGON_DATABASE 
				...
				+"&SELECTION_ORIG_LABEL_LOV0="+SELECTION_ORIG_LABEL_LOV0+"&SELECTION_SUBTYPE_ID_0="+SELECTION_SUBTYPE_ID_0+"&SELECTION_PROD_ID_0="+SELECTION_PROD_ID_0
				+"&LOV36="+LOV36+"&numOfRowsInTable=20&json=false&handlePopups=false";		
			
		
		Reporter.logEvent(Status.INFO, "Prepare test data for SUCU by PRODUCT service", this.queryString.replaceAll("&", "\n"), false);
	}
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run SUCU_Customize_by_Product service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run SUCU_Customize_by_Product service", "Running Failed:", false);
		}
	}
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForSUCUbyProd")[1], SELECTION_PROD_ID_0, doc.getElementsByTagName("TXN_TRANSLATION_TRANSACTION_0").item(0).getTextContent());
...
//		return queryResultSet.getString("TRANSACTION");
	}
