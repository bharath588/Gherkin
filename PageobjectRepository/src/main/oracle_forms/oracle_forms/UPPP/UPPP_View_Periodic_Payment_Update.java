...
public class UPPP_View_Periodic_Payment_Update {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/UPPP_View_Periodic_Payment_Update";
			...
			Reporter.logEvent(
					...
					"Values from Auraplayer: ",
							...
							+ doc.getElementsByTagName(
									"CONTROL_BUTTON_OTHER_FORMS_0").item(0)
