...
public class LDLR_Loan_Report_by_ProvCO {
	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/LDLR_Defaulted_Loan_Report_by_PROVIDING_CO";
	...
	public void setServiceParameters() throws SQLException
	{
		 ...
		 Reporter.logEvent(Status.INFO, "Prepare test data for LDLR By Prov Code service", this.queryString.replaceAll("&", "\n"), false);
	}
	...
	public void runService() throws SQLException {
		...
		//		System.out.println(serviceURL);
				...
				Reporter.logEvent(Status.PASS, "Run  LDLR Defaulted Loan Report by PROV CO service", "Execution Done!", false);
			} catch (Exception e) {
				e.printStackTrace();
				Globals.exception = e;
				Reporter.logEvent(Status.FAIL, "Run LDLR Defaulted Loan Report by PROV CO service", "Running Failed:", false);
			}
