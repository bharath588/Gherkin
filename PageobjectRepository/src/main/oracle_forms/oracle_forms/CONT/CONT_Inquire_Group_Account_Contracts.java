...
public class CONT_Inquire_Group_Account_Contracts {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/QYCONT_Inquire_Group_Account_Contracts";
	...
	public void setServiceParameters()	throws SQLException
	{
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for CONT service", this.queryString.replaceAll("&", "\n"), false);
	}
...
//			System.out.println(serviceURL);
			...
			Reporter.logEvent(Status.PASS, "Run CONT service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run CONT service", "Running Failed:", false);
		}
	}
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response: ", 
					...
					"\nCNTY_CODE: "+ doc.getElementsByTagName("GRC1_CNTY_CODE_0").item(0).getTextContent()
					, false);
		} else {
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCONT")[1], this.GET_GA_GA_ID_0);
		
		if(queryResultSet.next()){
			Reporter.logEvent(Status.PASS, "Validating Records exists for Account Transaction", "Records exists for Account Transaction\nTable Name: GA#GRP_CONTRACT\nGROUP_ACCOUNT\nGROUP_CONTRACT\nCONTRACT_TYPE", false);
			...
			Reporter.logEvent(Status.INFO, "Values From Database: ", 					
					...
					"\nCNTY_CODE: "+queryResultSet.getString("CNTY_CODE")+
