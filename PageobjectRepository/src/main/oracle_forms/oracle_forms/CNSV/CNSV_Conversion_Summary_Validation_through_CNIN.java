...
public class CNSV_Conversion_Summary_Validation_through_CNIN {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/CNSV_Conversion_Summary_Validation_through_CNIN";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for CNSV service",
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run CNSV service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run CNSV service",
		...
		if (Error.isEmpty()) {
			...
			Reporter.logEvent(Status.INFO,
					...
					"Auraplayer response values: "
							+ "\nWORK_CONV_PART_SSN_0: "
							+ doc.getElementsByTagName("WORK_CONV_PART_SSN_0")
									.item(0).getTextContent()
							+ "\nINP1_DISP_DFT_VALUE_0: "
							+ doc.getElementsByTagName("INP1_DISP_DFT_VALUE_0")
	...
	public void validateInDatabase() throws SQLException {
		...
		String ssn = doc.getElementsByTagName("WORK_CONV_PART_SSN_0").item(0)
				.getTextContent();
