...
public class VSCI_Cascade_Vesting_Schedule_Groupings_Error {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/VSCI_Cascade_Vesting_Schedule_Groupings_Error";
	...
	public void validateInDatabase() throws SQLException{
		...
		/*if(queryResultSet.next()){			
			...
			Reporter.logEvent(Status.PASS, "From DATABASE:" , "Table: IND_VESTING_RULE"+"New Record has been inserted into table\nTotal Count: "+DB.getRecordSetCount(queryResultSet),false);
