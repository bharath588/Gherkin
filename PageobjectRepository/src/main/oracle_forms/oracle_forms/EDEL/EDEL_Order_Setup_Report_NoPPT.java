...
public class EDEL_Order_Setup_Report_NoPPT {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/EDEL_Order_Setup_Report_NoPPT";
	...
	public void validateOutput() throws SQLException {
		...
		if (Error.isEmpty()) {
			...
			Reporter.logEvent(
					Status.PASS,
					"From Response: ",
					"EDEL_Order_Setup_Report_NoPPTElements: "
							+ doc.getElementsByTagName("EDEL_Order_Setup_Report_NoPPTElements")
