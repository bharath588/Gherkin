...
public class MSGR_View_Message {
	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/MSGR_View_Message_Type_Notification_Rules";
	...
	public String getMSG_TYPE_hash_MSG_NOTIFICATION_RULE_MSG_CD_SEL_CHKBOX_0() {
		return MSG_TYPE_hash_MSG_NOTIFICATION_RULE_MSG_CD_SEL_CHKBOX_0;
	}
	...
	public void runService() throws SQLException {
		...
		//		System.out.println(serviceURL);
				...
				Reporter.logEvent(Status.PASS, "Run  MSGR_View_Message_Type_Notification_Rules service", "Execution Done!", false);
			} catch (Exception e) {
				e.printStackTrace();
				Globals.exception = e;
				Reporter.logEvent(Status.FAIL, "Run MSGR_View_Message_Type_Notification_Rules service", "Running Failed:", false);
			}
	...
	public void validateOutput() throws SQLException{
		...
		Reporter.logEvent(Status.INFO, "Values From response: ","MSG_TYPE: "+doc.getElementsByTagName("MSG_TYPE_hash_MSG_NOTIFICATION_RULE_MSG_TEXT_0").item(0).getTextContent()+
		"\n",false);
	}
