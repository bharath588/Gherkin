 ...
 *
 */
public class CSIP_Negative_Balance {
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_NEGATIVE_BALANCE_REMITTANCE";
	...
	public void setAG_REMIT_SDMT_CODE_0(String aG_REMIT_SDMT_CODE_LOV) {
		AG_REMIT_SDMT_CODE_0 = aG_REMIT_SDMT_CODE_LOV;
	}
	...
	public void setServiceParameters(String remit_id, String effdate)	
	{
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&REMIT_NOTICE_ID_0="+REMIT_NOTICE_ID_0+"&AG_REMIT_AMOUNT_0="+AG_REMIT_AMOUNT_0+"&AG_REMIT_SDMT_CODE_0="+AG_REMIT_SDMT_CODE_0+"&AG_REMIT_GDMT_SEQNBR_0="+AG_REMIT_GDMT_SEQNBR_0+"&AG_REMIT_PAYROLL_DATE_0="+AG_REMIT_PAYROLL_DATE_0+
				"&IND_REMIT_NEW_SSN_0="+IND_REMIT_NEW_SSN_0+"&IND_REMIT_SUM_AMOUNT_1_0="+IND_REMIT_SUM_AMOUNT_1_0+"&IND_REMIT_NEW_SSN_1="+IND_REMIT_NEW_SSN_1+"&IND_REMIT_SUM_AMOUNT_1_1="+IND_REMIT_SUM_AMOUNT_1_1+
				"&numOfRowsInTable=20&json=false&handlePopups=false&useLabelsAsKeys=false";

		Reporter.logEvent(Status.INFO, "Prepare test data for CSIP_NEGATIVE_BALANCE_REMITTANCE service", 
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run CSIP_NEGATIVE_BALANCE_REMITTANCE service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run CSIP_NEGATIVE_BALANCE_REMITTANCE service", "Running Failed:", false);
		}
	}
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCSIPRemitNegetiveBal")[1], rmnc_id);
