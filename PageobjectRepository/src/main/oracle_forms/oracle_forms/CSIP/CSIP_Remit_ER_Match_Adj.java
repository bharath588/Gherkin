...
public class CSIP_Remit_ER_Match_Adj {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_REMIT_WITH_ER_MATCH_ADJ";
	...
	public String getREMIT_NOTICE_ID_0() {
		return REMIT_NOTICE_ID_0;
	}
	...
	public void setServiceParameters(String remit_id, String effdate)	
	{
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				...
				"&IND_REMIT_NEW_SSN_0="+IND_REMIT_NEW_SSN_0+"&IND_REMIT_SUM_AMOUNT_1_0="+IND_REMIT_SUM_AMOUNT_1_0+"&IND_REMIT_NEW_SSN_1="+
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response ", "ER_MATCH_MSGS_SSN_0: "+doc.getElementsByTagName("ER_MATCH_MSGS_SSN_0").item(0).getTextContent(), false);
		} else {
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCSIPRemitERMatchAdj1")[1], rmnc_id);
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCSIPRemitERMatchAdj2")[1], rmnc_id);
		if(DB.getRecordSetCount(queryResultSet)>0){
			Reporter.logEvent(Status.PASS, "Validating existence of data in the Database", "Record exists in the Database\nTable Name: IND_REMIT_ADJUSTMENT", false);
			while(queryResultSet.next()){
				Reporter.logEvent(Status.INFO, "From Database ", "RMNC_ID: "+queryResultSet.getString("RMNC_ID")+
						"\nAMOUNT: "+queryResultSet.getString("ADJUSTMENT_AMOUNT")+
						"\nADJ_AMOUNT: "+queryResultSet.getString("ADJUSTMENT_CODE")+
						"\nADJ_REASON: "+queryResultSet.getString("ADJUSTMENT_REASON"), false);
			}
		}else{
			Reporter.logEvent(Status.FAIL, "Validating existence of data in the Database", "Record doesn't exists in the Database", false);
		}
