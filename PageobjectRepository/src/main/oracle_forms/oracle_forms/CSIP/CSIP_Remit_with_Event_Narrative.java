...
public class CSIP_Remit_with_Event_Narrative {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_REMIT_WITH_EVENT_NARRATIVE";
	...
	String REMIT_NOTICE_NARRATIVE_0;
	...
	public void setREMIT_NOTICE_EVENT_NARRATIVE_0(
			String rEMIT_NOTICE_EVENT_NARRATIVE_0) {
		REMIT_NOTICE_EVENT_NARRATIVE_0 = rEMIT_NOTICE_EVENT_NARRATIVE_0;
	}
	public void setREMIT_NOTICE_NARRATIVE_0(String rEMIT_NOTICE_NARRATIVE_0) {
		REMIT_NOTICE_NARRATIVE_0 = rEMIT_NOTICE_NARRATIVE_0;
	}
	...
	public void setServiceParameters(String remit_id, String effdate)	
	{
		...
		this.setREMIT_NOTICE_NARRATIVE_0(Stock.GetParameterValue("REMIT_NOTICE_NARRATIVE_0"));
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&REMIT_NOTICE_ID_0="+REMIT_NOTICE_ID_0+"&REMIT_NOTICE_EVENT_NARRATIVE_0="+REMIT_NOTICE_EVENT_NARRATIVE_0+"&REMIT_NOTICE_NARRATIVE_0="+REMIT_NOTICE_NARRATIVE_0+
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response ", "AMOUNT: "+doc.getElementsByTagName("AG_REMIT_2_AMOUNT_0").item(0).getTextContent()+
					"\nPAYROLL_DATE: "+doc.getElementsByTagName("AG_REMIT_2_PAYROLL_DATE_0").item(0).getTextContent()+
					"\nSDMT_CODE: "+doc.getElementsByTagName("AG_REMIT_SDMT_CODE_0").item(0).getTextContent()+
					"\nEV_ID: "+doc.getElementsByTagName("IND_REMIT_CTRL_EV_ID_0").item(0).getTextContent(), false);
		} else {
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCSIPRemitEventNarrative")[1], rmnc_id);
		if(DB.getRecordSetCount(queryResultSet)>0){
			...
			while(queryResultSet.next()){
				narrative = queryResultSet.getString("NARRATIVE");
				Reporter.logEvent(Status.INFO, "From Database ", "EV_ID: "+queryResultSet.getString("ID")+
			...
			if(narrative.equalsIgnoreCase(this.REMIT_NOTICE_EVENT_NARRATIVE_0)){
				Reporter.logEvent(Status.PASS, "Event Narrative should be \"Test Event Narrative \" ","Event Narrative from Database: "+narrative, false);
			}else{
				Reporter.logEvent(Status.FAIL, "Event Narrative should be \"Test Event Narrative \" ","Event Narrative from Database: "+narrative, false);
			}
		}else{
