...
public class CSIP_Delete_Records_via_Shift_F9 {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/CSIP_Delete_Records_via_Shift_F9";
	...
	public void setServiceParameters(String remit_id) {
		...
		this.setAG_REMIT_AMOUNT_0(Stock
				.GetParameterValue("AG_REMIT_AMOUNT_0"));
		this.setAG_REMIT_PAYROLL_DATE_0(Stock
				.GetParameterValue("AG_REMIT_PAYROLL_DATE_0"));
		this.setAG_REMIT_SDMT_CODE_LOV(Stock
				.GetParameterValue("AG_REMIT_SDMT_CODE_LOV"));
		this.setIND_REMIT_NEW_SSN_0(Stock
				.GetParameterValue("IND_REMIT_NEW_SSN_0"));
		this.setIND_REMIT_NEW_SSN_1(Stock
				.GetParameterValue("IND_REMIT_NEW_SSN_1"));
		this.setIND_REMIT_SUM_AMOUNT_1_0(Stock
				.GetParameterValue("IND_REMIT_SUM_AMOUNT_1_0"));
		this.setIND_REMIT_SUM_AMOUNT_1_1(Stock
				.GetParameterValue("IND_REMIT_SUM_AMOUNT_1_1"));

		queryString = "?AG_REMIT_AMOUNT_0="
				+AG_REMIT_AMOUNT_0
				+"&AG_REMIT_PAYROLL_DATE_0="
				+AG_REMIT_PAYROLL_DATE_0
				+"&AG_REMIT_SDMT_CODE_LOV="
				+AG_REMIT_SDMT_CODE_LOV
				+"&CONTROL_SELECTION_0="
				+CONTROL_SELECTION_0
				+"&IND_REMIT_NEW_SSN_0="
	...
	public void validateInDatabase() throws SQLException {
		...
		queryResultSet = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForCSIPDeleteRecords1")[1], rmnc_id);
