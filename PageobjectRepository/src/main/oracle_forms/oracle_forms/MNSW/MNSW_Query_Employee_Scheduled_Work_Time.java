...
public class MNSW_Query_Employee_Scheduled_Work_Time {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/MNSW_Query_Employee_Scheduled_Work_Time";
	...
	public void setServiceParameters()	throws SQLException
	{
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&HEADER_USER_LOGON_ID_0="+HEADER_USER_LOGON_ID_0+"&numOfRowsInTable=20&json=false&handlePopups=false&useLabelsAsKeys=false";
		
		Reporter.logEvent(Status.INFO, "Prepare test data for MNSW Query Employee Schedule Work Time service", this.queryString.replaceAll("&", "\n"), false);
...
//			System.out.println(serviceURL);
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForMNSWQuery")[1],  this.HEADER_USER_LOGON_ID_0 );
		...
		if(queryResultSet.next()){
			...
			Reporter.logEvent(Status.FAIL, "Validating Records exists in Database for Querying Employee Schedule Worktime", "No records exists in Database", false);
		}
