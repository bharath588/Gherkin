...
public class RADB_Ppt_All_SSN {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/RADB_Participant_all_SSN";
	...
	public void setServiceParameters()	
	{
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&CONTROL_GA_ID_0="+CONTROL_GA_ID_0+"&CONTROL_SSN_0="+CONTROL_SSN_0+"&CONTROL_ADB_BEGIN_DATE_0="+CONTROL_ADB_BEGIN_DATE_0+"&CONTROL_ADB_END_DATE_0="+CONTROL_ADB_END_DATE_0+		
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run RADB All Ppt SSN service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run RADB All Ppt SSN service", "Running Failed:", false);
		}
	}
