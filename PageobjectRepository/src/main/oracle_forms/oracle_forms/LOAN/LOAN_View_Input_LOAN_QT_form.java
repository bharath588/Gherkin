...
public class LOAN_View_Input_LOAN_QT_form {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/LOAN_View_Input_LOAN_QT_form";
	...
	public void setServiceParameters() throws SQLException {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for LOAN service",
	...
	public void runService() throws SQLException {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run  LOAN service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run LOAN service",
	...
	public void validateOutput() throws SQLException {
		...
		if (Error.isEmpty()) {
			Reporter.logEvent(Status.PASS,
					...
					false);
			Reporter.logEvent(Status.INFO, "Values from Auraplayer: ", "\nINDIVIDUAL_LAST_NAME_0: "
					+doc.getElementsByTagName("INDIVIDUAL_LAST_NAME_0").item(0).getTextContent()
					+"\nCONTROL_BUTTON_OTHER_FORMS_0: "
					+doc.getElementsByTagName("CONTROL_BUTTON_OTHER_FORMS_0").item(0).getTextContent(), false);
		} else {
