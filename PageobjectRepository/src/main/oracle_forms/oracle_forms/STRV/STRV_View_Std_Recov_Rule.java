...
public class STRV_View_Std_Recov_Rule {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/STRV_View_Standard_Recovery_Rule";
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "Values from Response", "EFFDATE: "+doc.getElementsByTagName("RECOV_STRUC_EFFDATE_0").item(0).getTextContent()+					
					...
					"\nCALC_LEVEL_DESCR: "+doc.getElementsByTagName("RECOV_STRUC_N_CALC_LEVEL_DESCR_0").item(0).getTextContent(), false);
