...
public class IPRR_Ind_Level_RateofReturn {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/IPRR_Individual_Level_Rate_Of_Return";
	...
	//		System.out.println(fileName+" : "+lastmodified);
			if(fileName.matches("IROR*")){ //&& dateFormat.format(Calendar.getInstance().getTime()).equals(dateFormat.format(directory.lastModified()))){
