...
public class GPGI_View_GA_Related_Investment_Option {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/GPGI_View_GA_Related_Investment_Option";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for GPGI service",
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run GPGI service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run GPGI service",
	...
	public void validateOutput() throws SQLException {
		...
		if (Error.isEmpty()) {
			...
			Reporter.logEvent(
					...
					"HEADER_PRODUCT_0: "
							+ doc.getElementsByTagName("HEADER_PRODUCT_0").item(0)
									.getTextContent()
							+ "\nHEADER_GC_NAME_0: "
							+ doc.getElementsByTagName("HEADER_GC_NAME_0")
									.item(0).getTextContent()
									+"\nHEADER_PLAN_NAME_0: "
											+ doc.getElementsByTagName("HEADER_PLAN_NAME_0").item(0)
											.getTextContent()
									+ "\nPOOL_INVOPT1_MASTER_RECKEEPING_LEVEL_0: "
									+ doc.getElementsByTagName("POOL_INVOPT1_MASTER_RECKEEPING_LEVEL_0")
	...
	public void validateInDatabase() throws SQLException {
		...
		queryResultSet = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForEGAR")[1],this.GET_GA_GA_ID_0);
