...
public class VSGR_Updt_Vest_Calc_Input_No_Part_Vest_NotAllowed {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/VSGR_Updt_Vest_Calc_Input_No_Part_Vest_NotAllowed";
	...
	public void setServiceParameters() throws Exception
	{
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for VSGR_Updt_Vest_Calc_Input_No_Part_Vest_NotAllowed service", this.queryString.replaceAll("&", "\n"), false);
	}
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run VSGR_Updt_Vest_Calc_Input_No_Part_Vest_NotAllowed service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run VSGR_Updt_Vest_Calc_Input_No_Part_Vest_NotAllowed service", "Running Failed:", false);
		}
	}
	...
	public void validateOutput()
	{
		...
		if(Error.isEmpty())
		{
			...
			Reporter.logEvent(Status.INFO, "Values from Response", "GET_GA_PLAN_NAME_0: "+doc.getElementsByTagName("Error").item(0).getTextContent()+
					"\nGET_GA_PROD_ID_0: "+doc.getElementsByTagName("GET_GA_PROD_ID_0").item(0).getTextContent()+
					"\nSTEP_TYPE_DESCR_0: "+doc.getElementsByTagName("STEP_TYPE_DESCR_0").item(0).getTextContent(), false);
		}else{
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForVSGR_Updt_No_PartVest_NotAllowed")[1], this.GET_GA_GA_ID_0);
