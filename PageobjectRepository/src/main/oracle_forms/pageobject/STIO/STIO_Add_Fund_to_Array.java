...
public class STIO_Add_Fund_to_Array {

	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/STIO_Add_Fund_to_Array";
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response", "FUND ARRAY NAME: "+doc.getElementsByTagName("ASSOC_FUND_WITH_FUND_ARRAY_NAME_0").item(0).getTextContent()+
					"\nSDIO ID: "+doc.getElementsByTagName("ASSOC_FUND_WITH_FUND_ARRAY_SDIO_ID_0").item(0).getTextContent()+
					"\nSTART DATE: "+doc.getElementsByTagName("INPUT_LINE_START_STATUS_START_DATE_0").item(0).getTextContent()+
					"\nPROD PVCO: "+doc.getElementsByTagName("ASSOC_FUND_WITH_FUND_ARRAY_PROD_PVCO_0").item(0).getTextContent()
					, false);
