...
public class LDLR_Loan_Report_by_ProdID {
	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/LDLR_Defaulted_Loan_Report_by_PROD_ID";
	...
	public void setServiceParameters() throws SQLException
	{
		 ...
		 Reporter.logEvent(Status.INFO, "Prepare test data for LDLR By Prod ID service", this.queryString.replaceAll("&", "\n"), false);
	}
	...
	public void runService() throws SQLException {
		...
		//		System.out.println(serviceURL);
				...
				Reporter.logEvent(Status.PASS, "Run  LDLR Defaulted Loan Report by PROD ID service", "Execution Done!", false);
			} catch (Exception e) {
				e.printStackTrace();
				Globals.exception = e;
				Reporter.logEvent(Status.FAIL, "Run LDLR Defaulted Loan Report by PROD ID service", "Running Failed:", false);
			}
	...
	public void validateOutput() throws SQLException{
		...
		Reporter.logEvent(Status.INFO, "Values From response: ","TRANSACTION_CODE_0: "+doc.getElementsByTagName("TRANSACTION_CODE_0").item(0).getTextContent()+
