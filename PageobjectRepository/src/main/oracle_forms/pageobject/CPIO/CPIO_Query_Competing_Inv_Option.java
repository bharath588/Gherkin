...
public class CPIO_Query_Competing_Inv_Option {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CPIO_Query_Competing_Investment_Option";
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCPIOAdd")[1],  this.CPIO1_CODE_0);
