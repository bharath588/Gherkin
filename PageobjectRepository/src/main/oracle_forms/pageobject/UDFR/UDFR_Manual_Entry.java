...
public class UDFR_Manual_Entry {
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO,
				"Prepare test data for UDFR_manual_entry service",
	...
	public void validateInDatabase() throws SQLException {
		queryResultSet = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForUDFRManualEntry1")[1],
		...
		queryResultSet1 = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForUDFRManualEntry2")[1],
				this.CONTROL_BLOCK_NEW_REQ_SERVICE_REQUEST_NBR_0,
