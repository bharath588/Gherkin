...
public class UDFR_ApplySelectRecs {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/UDFR_Applyselectrecs";
	...
	String UPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0;
	String CONTROL_BLOCK_MASS_FIELD_SELECTION_0;
	String CONTROL_BLOCK_MASS_NUMBER_VALUE_0;
	...
	public void setUPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0(
			String uPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0) {
		UPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0 = uPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0;
	}

	public void setCONTROL_BLOCK_MASS_FIELD_SELECTION_0(
			String cONTROL_BLOCK_MASS_FIELD_SELECTION_0) {
		CONTROL_BLOCK_MASS_FIELD_SELECTION_0 = cONTROL_BLOCK_MASS_FIELD_SELECTION_0;
	}

	public void setCONTROL_BLOCK_MASS_NUMBER_VALUE_0(
			String cONTROL_BLOCK_MASS_NUMBER_VALUE_0) {
		CONTROL_BLOCK_MASS_NUMBER_VALUE_0 = cONTROL_BLOCK_MASS_NUMBER_VALUE_0;
	}
	...
	public void setServiceParameters() {
		...
		this.setUPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0(Stock
				.GetParameterValue("UPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0"));
		this.setCONTROL_BLOCK_MASS_FIELD_SELECTION_0(Stock
				.GetParameterValue("CONTROL_BLOCK_MASS_FIELD_SELECTION_0"));
		this.setCONTROL_BLOCK_MASS_NUMBER_VALUE_0(Stock
				.GetParameterValue("CONTROL_BLOCK_MASS_NUMBER_VALUE_0"));
		...
		queryString = "?LOGON_USERNAME="
				...
				+ UPLOAD_DEFERRAL_DATA_BLOCK_PERCENTAGE_0
				+ "&UPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0="
				+ UPLOAD_DEFERRAL_DATA_BLOCK_SELECTED_IND_0
				+ "&CONTROL_BLOCK_MASS_FIELD_SELECTION_0="
				+ CONTROL_BLOCK_MASS_FIELD_SELECTION_0
				+ "&CONTROL_BLOCK_MASS_NUMBER_VALUE_0="
				+ CONTROL_BLOCK_MASS_NUMBER_VALUE_0
				+ "&numOfRowsInTable=20&json=false&handlePopups=false&useLabelsAsKeys=false";

		Reporter.logEvent(Status.INFO,
				"Prepare test data for UDFR_Applyselectrecs service",
			...
			Reporter.logEvent(
					...
					"ALL_UPLOAD_REQUEST_BLOCK_ID_0: "
							+ doc.getElementsByTagName(
									...
									.getTextContent()
							+ "\nCONTROL_BLOCK_MASS_YN_SELECTION_0: "
							+ doc.getElementsByTagName(
									"CONTROL_BLOCK_MASS_YN_SELECTION_0")
	...
	public void validateInDatabase() throws SQLException {
		String upload_Req_ID = doc
				.getElementsByTagName("ALL_UPLOAD_REQUEST_BLOCK_ID_0").item(0)
				.getTextContent();
		...
		if (DB.getRecordSetCount(queryResultSet) > 0) {
			...
			while (queryResultSet.next()) {
				String statusCode_DB = queryResultSet.getString("STATUS_CODE");
				String changeCODE_DB = queryResultSet.getString("CHANGE_CODE");
				Reporter.logEvent(Status.INFO, "Values from DB: ",
						"Status Code: " + statusCode_DB + " and Change Code: "
								+ changeCODE_DB, false);
				if (this.UPLOAD_DEFERRAL_DATA_BLOCK_STATUS_CODE_0
						.equals(statusCode_DB)
						&& this.UPLOAD_DEFERRAL_DATA_BLOCK_CHANGE_CODE_0
								.equals(changeCODE_DB)) {
					Reporter.logEvent(
							Status.PASS,
		...
		queryResultSet1 = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForUDFRDateValid2")[1],
				this.CONTROL_BLOCK_NEW_REQ_SERVICE_REQUEST_NBR_0,
				this.CONTROL_BLOCK_NEW_REQ_UPLOAD_REASON_0);
