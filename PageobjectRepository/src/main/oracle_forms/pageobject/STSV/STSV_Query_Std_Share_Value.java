...
public class STSV_Query_Std_Share_Value {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/STSV_Query_Standard_Share_Value";
	...
	public void validateInDatabase()throws SQLException{	
		String asset_val = null;
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForSTSV_Query1")[1], this.HEADER_INVEST_ID_0);			
			if(DB.getRecordSetCount(queryResultSet)>0){
				...
				while(queryResultSet.next()){	
					asset_val = queryResultSet.getString("NET_ASSET_VALUE");
