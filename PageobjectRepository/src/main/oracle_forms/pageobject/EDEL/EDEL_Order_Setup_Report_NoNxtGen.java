...
public class EDEL_Order_Setup_Report_NoNxtGen {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/EDEL_Order_Setup_Report_NoNxtGen";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO,
				"Prepare test data for EDEL_Order_Setup_Report_CONFIRM service",
	...
	public void validateOutput() throws SQLException {
		...
		if (Error.isEmpty()) {
			...
			Reporter.logEvent(
					Status.PASS,
					"From Response: ",
					"EDEL_Order_Setup_Report_NoNxtGenElements: "
							+ doc.getElementsByTagName("EDEL_Order_Setup_Report_NoNxtGenElements")
