...
public class EDEL_Order_Setup_Report_STATEMENT {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/EDEL_Order_Setup_Report_STATEMENT";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO,
				"Prepare test data for EDEL_Order_Setup_Report_ACTIVE service",
