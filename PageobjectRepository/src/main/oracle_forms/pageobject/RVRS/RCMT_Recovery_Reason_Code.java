...
public class RCMT_Recovery_Reason_Code {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/RCMT_recovery_reason_code";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for RVRS service",
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run RVRS service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run RVRS service",
	...
	public void validateInDatabase() throws SQLException {
		...
		queryResultSet = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForRVRS")[1]);
