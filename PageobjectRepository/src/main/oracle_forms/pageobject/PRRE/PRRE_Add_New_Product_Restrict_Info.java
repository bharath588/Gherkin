...
public class PRRE_Add_New_Product_Restrict_Info {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PRRE_Add_New_Product_Restriction_Information";
	...
	String PURS1_EFFDATE_0;
	String PURS2_EFFDATE_0;
	String PURS3_EFFDATE_0;
	...
	public void setPURS1_EFFDATE_0(String pURS1_EFFDATE_0) {
		PURS1_EFFDATE_0 = pURS1_EFFDATE_0;
	}
	public void setPURS2_EFFDATE_0(String pURS2_EFFDATE_0) {
		PURS2_EFFDATE_0 = pURS2_EFFDATE_0;
	}
	public void setPURS3_EFFDATE_0(String pURS3_EFFDATE_0) {
		PURS3_EFFDATE_0 = pURS3_EFFDATE_0;
	}
	...
	public void setServiceParameters()	
	{
		...
		this.setPURS1_EFFDATE_0(Stock.GetParameterValue("PURS1_EFFDATE_0"));
		this.setPURS2_EFFDATE_0(Stock.GetParameterValue("PURS2_EFFDATE_0"));
		this.setPURS3_EFFDATE_0(Stock.GetParameterValue("PURS3_EFFDATE_0"));
		
		queryString = "?CONTROL_SELECTION_0="+CONTROL_SELECTION_0+"&GET_PROD_ID_0="+GET_PROD_ID_0+"&LOGON_DATABASE="+LOGON_DATABASE+
				"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_USERNAME="+LOGON_USERNAME+"&PURS1_EFFDATE_0="+PURS1_EFFDATE_0+
				"&PURS2_EFFDATE_0="+PURS2_EFFDATE_0+"&PURS3_EFFDATE_0="+PURS3_EFFDATE_0+"&numOfRowsInTable=20&json=false&handlePopups=false&useLabelsAsKeys=false";
...
//			System.out.println(serviceURL);
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response", "SDMT_CODE: "+doc.getElementsByTagName("PURS1_SDMT_CODE_0").item(0).getTextContent()+
					"\nCNTY_CODE: "+doc.getElementsByTagName("PURS2_CNTY_CODE_0").item(0).getTextContent()+
					"\nTYPE_CODE: "+doc.getElementsByTagName("PURS3_MK_TYPE_CODE_0").item(0).getTextContent(), false);
		} else {
	...
	public void FlushData(){
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForPRREDelete")[1], this.GET_PROD_ID_0);
