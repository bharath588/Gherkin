...
public class PRRE_Change_Product_Restric_Info {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PRRE_Change_Product_Restriction_Information";
	...
	String PURS1_TERMDATE_0;
	String PURS1_TERMDATE_0_X1;
	...
	public void setPURS1_TERMDATE_0(String pURS1_TERMDATE_0) {
		PURS1_TERMDATE_0 = pURS1_TERMDATE_0;
	}
	public void setPURS1_TERMDATE_0_X1(String pURS1_TERMDATE_0_X1) {
		PURS1_TERMDATE_0_X1 = pURS1_TERMDATE_0_X1;
	}
	...
	public void setServiceParameters()	
	{
		...
		this.setPURS1_TERMDATE_0(Stock.GetParameterValue("PURS1_TERMDATE_0"));
		this.setPURS1_TERMDATE_0_X1(Stock.GetParameterValue("PURS1_TERMDATE_0_X1"));
		
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&GET_PROD_ID_0="+GET_PROD_ID_0+"&PURS1_TERMDATE_0="+PURS1_TERMDATE_0+"&PURS1_TERMDATE_0_X1="+PURS1_TERMDATE_0_X1+
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response", 
					"\nSDMT_CODE: "+doc.getElementsByTagName("PURS1_SDMT_CODE_0").item(0).getTextContent(), false);
		} else {
