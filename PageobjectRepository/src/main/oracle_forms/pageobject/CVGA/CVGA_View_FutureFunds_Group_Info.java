...
public class CVGA_View_FutureFunds_Group_Info {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/CVGA_View_FutureFunds_Group_Info";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for CVGA service",
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run CVGA service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run CVGA service",
	...
	public void validateOutput() throws SQLException {
		...
		if (Error.isEmpty()) {
			...
			Reporter.logEvent(Status.INFO,
					...
					+ "\nGROUP_HEADER1_GA_ID_0: " + doc.getElementsByTagName("GROUP_HEADER1_GA_ID_0").item(0).getTextContent()
					+ "\nGROUP_HEADER1_PLAN_NAME_0: " + doc.getElementsByTagName("GROUP_HEADER1_PLAN_NAME_0").item(0).getTextContent()
					+ "\nGROUP_HEADER1_PROD_ID_0: " + doc.getElementsByTagName("GROUP_HEADER1_PROD_ID_0").item(0).getTextContent(),
					false);
