...
public class GARI_View_Alloc_Restrict_Rule {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/GARI_View_Alloc_Restrict_Rule1";
	...
	public void setServiceParameters()	throws SQLException
	{
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for ALRI service", this.queryString.replaceAll("&", "\n"), false);
	}
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run ALRI service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run ALRI service", "Running Failed:", false);
		}
	}
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response: ", 
					...
					"\nGROUP_HEADER_N_IRSRL_CODE_0: "+ doc.getElementsByTagName("GROUP_HEADER_N_IRSRL_CODE_0").item(0).getTextContent()+
					"\nCONTROL_GROUP_DATE_0: "+ doc.getElementsByTagName("CONTROL_GROUP_DATE_0").item(0).getTextContent()
					, false);
		} else {
