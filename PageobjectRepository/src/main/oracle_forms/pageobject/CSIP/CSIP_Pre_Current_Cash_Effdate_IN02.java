...
public class CSIP_Pre_Current_Cash_Effdate_IN02 {

	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_PRE_CURRENT_CASH_EFFDATE_IN02";
	...
	String REMIT_NOTICE_CASH_EFFDATE_0;
	...
	public void setREMIT_NOTICE_CASH_EFFDATE_0(String rEMIT_NOTICE_CASH_EFFDATE_0) {
		REMIT_NOTICE_CASH_EFFDATE_0 = rEMIT_NOTICE_CASH_EFFDATE_0;
	}
	...
	public void setServiceParameters(String remit_id)	
	{
		...
		this.setREMIT_NOTICE_CASH_EFFDATE_0(Stock.GetParameterValue("REMIT_NOTICE_CASH_EFFDATE_0"));
		
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&REMIT_NOTICE_ID_0="+REMIT_NOTICE_ID_0+"&REMIT_NOTICE_CASH_EFFDATE_0="+REMIT_NOTICE_CASH_EFFDATE_0+"&AG_REMIT_AMOUNT_0="+AG_REMIT_AMOUNT_0+"&AG_REMIT_SDMT_CODE_LOV="+
				AG_REMIT_SDMT_CODE_LOV+"&AG_REMIT_PAYROLL_DATE_0="+AG_REMIT_PAYROLL_DATE_0+				
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response ", "IND_REMIT_CTRL_EV_ID_0: "+doc.getElementsByTagName("IND_REMIT_CTRL_EV_ID_0").item(0).getTextContent()+
					"\nAG_REMIT_GA_ID_0: "+doc.getElementsByTagName("AG_REMIT_GA_ID_0").item(0).getTextContent(), false);
		} else {
	...
	public void validateInDatabase()throws SQLException{
		...
		if(DB.getRecordSetCount(queryResultSet)>0){
			Reporter.logEvent(Status.PASS, "Validating existence of data in the Database for RMNC_ID: "+rmnc_id, "Record exists in the Database\nTable Name: AG_REMIT", false);
			...
			Reporter.logEvent(Status.FAIL, "Validating existence of data in the Database for RMNC_ID: "+rmnc_id, "Record doesn't exists in the Database", false);
		}
	}
}
