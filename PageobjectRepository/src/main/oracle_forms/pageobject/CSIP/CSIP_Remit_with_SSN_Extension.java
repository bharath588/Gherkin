...
public class CSIP_Remit_with_SSN_Extension {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_REMIT_SSN_WITH_EXT_1";
		...
		if(DB.getRecordSetCount(queryResultSet)>0){
			...
			while(queryResultSet.next()){
				...
				Reporter.logEvent(Status.INFO, "From Database ", "ID: "+queryResultSet.getString("ID")+
						...
						"\nSSN_EXT: "+queryResultSet.getString("SSN_EXT"), false);
			}
		}else{
