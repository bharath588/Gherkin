...
public class CSIP_Remit_with_Multiple_Mny_Src {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_REMIT_MULTI_MNY_SRC";
	...
	String AG_REMIT_PAYROLL_DATE_1;
	String IND_REMIT_NEW_SSN_0;
	String IND_REMIT_SUM_AMOUNT_1_0;
	String IND_REMIT_SUM_AMOUNT_2_0;
	...
	public void setAG_REMIT_PAYROLL_DATE_1(String aG_REMIT_PAYROLL_DATE_1) {
		AG_REMIT_PAYROLL_DATE_1 = aG_REMIT_PAYROLL_DATE_1;
	}
	...
	public void setIND_REMIT_SUM_AMOUNT_2_0(String iND_REMIT_SUM_AMOUNT_2_0) {
		IND_REMIT_SUM_AMOUNT_2_0 = iND_REMIT_SUM_AMOUNT_2_0;
	}
	...
	public void setServiceParameters(String remit_id, String effdate)	
	{
		...
		this.setAG_REMIT_PAYROLL_DATE_1(effdate);
		...
		this.setIND_REMIT_SUM_AMOUNT_1_0(Stock.GetParameterValue("IND_REMIT_SUM_AMOUNT_1_0"));
		this.setIND_REMIT_SUM_AMOUNT_2_0(Stock.GetParameterValue("IND_REMIT_SUM_AMOUNT_2_0"));
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				...
				"&AG_REMIT_AMOUNT_1="+AG_REMIT_AMOUNT_1+"&AG_REMIT_SDMT_CODE_LOV_X1="+AG_REMIT_SDMT_CODE_LOV_X1+"&AG_REMIT_PAYROLL_DATE_1="+AG_REMIT_PAYROLL_DATE_1+
				"&IND_REMIT_NEW_SSN_0="+IND_REMIT_NEW_SSN_0+"&IND_REMIT_SUM_AMOUNT_1_0="+IND_REMIT_SUM_AMOUNT_1_0+"&IND_REMIT_SUM_AMOUNT_2_0="+IND_REMIT_SUM_AMOUNT_2_0+
	...
	public void validateInDatabase()throws SQLException{
		...
		String amnt_db = null;
		String amnt = this.IND_REMIT_SUM_AMOUNT_1_0;
