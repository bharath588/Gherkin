...
public class CSIP_Remit_with_Suspense_Narrative {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_REMIT_WITH_SUSPENSE_NARRATIVE";
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCSIPRemitSuspenseNarrative")[1], rmnc_id);
