...
public class CSIP_Post_Current_Cash_Effdate {

	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_POST_CURRENT_CASH_EFFDATE_IN02_2";
