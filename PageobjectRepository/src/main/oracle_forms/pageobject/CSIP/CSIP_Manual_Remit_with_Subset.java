...
public class CSIP_Manual_Remit_with_Subset {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CSIP_REMIT_WITH_SUBSET";
	...
	public void setGC_SUBSET_LOV(String aG_REMIT_PAYROLL_DATE_1) {
		GC_SUBSET_LOV = aG_REMIT_PAYROLL_DATE_1;
	}
	...
	public void setServiceParameters(String remit_id, String effdate)	
	{
		...
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&REMIT_NOTICE_ID_0="+REMIT_NOTICE_ID_0+"&GC_SUBSET_LOV="+GC_SUBSET_LOV+"&AG_REMIT_AMOUNT_0="+AG_REMIT_AMOUNT_0+"&AG_REMIT_SDMT_CODE_LOV="+AG_REMIT_SDMT_CODE_LOV+"&AG_REMIT_PAYROLL_DATE_0="+AG_REMIT_PAYROLL_DATE_0+				
