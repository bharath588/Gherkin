...
public class PTGR_Test_Active_Setup_Groupings {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PTGR_Test_Active_Setup_Groupings";
	...
	public void setServiceParameters()
	{
		...
		queryString = "?CHANGE_STATUS_BLOCK_TO_STATUS_0="+CHANGE_STATUS_BLOCK_TO_STATUS_0+"&CONTROL_SELECTION_0=" + CONTROL_SELECTION_0 + "&GET_GA_GA_ID_0=" + GET_GA_GA_ID_0 + "&LOGON_DATABASE=" + LOGON_DATABASE + "&LOGON_PASSWORD=" + LOGON_PASSWORD+"&LOGON_USERNAME="+LOGON_USERNAME
				+"&PART_GRPG_PURPOSE_LOV="+PART_GRPG_PURPOSE_LOV
