...
public class PTGR_test_Terminate_Setup_Groupings {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PTGR_Test_Terminate_Setup_Groupings";
	...
	public void setServiceParameters()
	{
		...
		queryString = "?CHANGE_STATUS_BLOCK_TO_STATUS_0="+CHANGE_STATUS_BLOCK_TO_STATUS_0+"&CONTROL_SELECTION_0=" + CONTROL_SELECTION_0 +
				"&GET_GA_GA_ID_0=" + GET_GA_GA_ID_0 +
				"&LIST_ACTIVE_SET_LOV="+LIST_ACTIVE_SET_LOV+
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "From Response", "CHANGE_STATUS_BLOCK_EFFDATE_0: "+doc.getElementsByTagName("CHANGE_STATUS_BLOCK_EFFDATE_0").item(0).getTextContent()+
					"\nCHANGE_STATUS_BLOCK_FROM_STATUS_0: "+doc.getElementsByTagName("CHANGE_STATUS_BLOCK_FROM_STATUS_0").item(0).getTextContent()+
					"\nGROUP_PURPOSE_CODE_0: "+doc.getElementsByTagName("GROUP_PURPOSE_CODE_0").item(0).getTextContent()+
					"\nPART_GRPG_PLAN_SEQUENCE_NUMBER_0: "+doc.getElementsByTagName("PART_GRPG_PLAN_SEQUENCE_NUMBER_0").item(0).getTextContent(), false);
		} else {
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForPTGRErrorSetupGroupings1")[1], this.GET_GA_GA_ID_0);
