...
public class PCPK_Inquire_Product_Compensation_Info {

	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PCPK_INQUIRE_PRODUCT_COMPENSATION_INFORMATION";
...
//			System.out.println(serviceURL);
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "Values from Response", "IRSRL_CODE: "+doc.getElementsByTagName("GET_PROD_IRSRL_CODE_0").item(0).getTextContent()+
					...
					"\nPKG_ID: "+doc.getElementsByTagName("PROD_COMP_PKG_COMP_PKG_ID_0").item(0).getTextContent()+
	...
	public void validateInDatabase() throws SQLException{
		...
		String pkg_id = doc.getElementsByTagName("PROD_COMP_PKG_COMP_PKG_ID_0").item(0).getTextContent();
		String pkg_id_db = null;
		
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForPCPKInq")[1], prod_id);
