...
public class DISD_Find_PPT_Disbursements {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/DISD_find_PPT_disbursements";
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for DISD service",
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run DISD service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run DISD service",
