...
public class ADIV_Create_Divd_Decl_Row {
	public String queryString;
	private String serviceURL = "http://"
			+ Stock.getConfigParam("TargetServiceHostServer").trim()
			+ ":8080/ServiceManager/Macro/ExecMacro/ADIV_create_divd_decl_row";
	...
	public void setDIVIDENDS_EX_DIVIDEND_DATE_0(
			String dIVIDENDS_EX_DIVIDEND_DATE_0) {
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO,
				"Prepare test data for ADIV_create_divd_decl_row",
	...
	public void validateOutput() throws SQLException {
		...
		if (Error.isEmpty()) {
			...
			Reporter.logEvent(
					Status.PASS,
					"From Response: ",
					"DIVIDENDS_LEGAL_NAME_0: "
							+ doc.getElementsByTagName("DIVIDENDS_LEGAL_NAME_0")
									.item(0).getTextContent()
							+ "\nDIVIDENDS_FUND_HOUSE_DECLARATION_IND_0: "
	...
	public void validateInDatabase() throws SQLException {
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForADIV1")[1], this.DIVIDENDS_SDIO_ID_0, this.DIVIDENDS_RECORD_DATE_0);
