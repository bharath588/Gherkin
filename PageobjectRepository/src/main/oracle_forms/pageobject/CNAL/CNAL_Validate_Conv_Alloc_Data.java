...
public class CNAL_Validate_Conv_Alloc_Data {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CNAL_Validate_Conversion_Allocation_data";
	...
	public void setServiceParameters()	
	{
		...
		queryString = "?CONTROL_SELECTION_0="+CONTROL_SELECTION_0+"&CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0="+CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0+"&LOGON_DATABASE="+LOGON_DATABASE+"&LOGON_PASSWORD="+LOGON_PASSWORD+
				"&LOGON_USERNAME="+LOGON_USERNAME+"&MO1_DISP_DFT_PRIN_CODE_0="+MO1_DISP_DFT_PRIN_CODE_0+
				"&numOfRowsInTable=20&json=false&handlePopups=false&useLabelsAsKeys=false";
		
		Reporter.logEvent(Status.INFO, "Prepare test data for CNAL service", this.queryString.replaceAll("&", "\n"), false);		
	}
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.PASS, "From Response: ", 
					"SSN: "+doc.getElementsByTagName("WORK_CONV_PART_SSN_0").item(0).getTextContent()+
					"\nGA_ID: "+doc.getElementsByTagName("INP1_DISP_DFT_VALUE_0").item(0).getTextContent(), false);
	...
	public void validateInDatabase()throws SQLException{
		...
		String ssn_db = null;
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCNAL")[1], ssn_resp);
