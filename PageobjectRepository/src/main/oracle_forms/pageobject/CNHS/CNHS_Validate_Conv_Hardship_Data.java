...
public class CNHS_Validate_Conv_Hardship_Data {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CNHS_Validate_Conversion_Hardship_data";
	...
	public void setServiceParameters()	throws SQLException
	{
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for CNHS service", this.queryString.replaceAll("&", "\n"), false);
...
//			System.out.println(serviceURL);
			...
			Reporter.logEvent(Status.PASS, "Run CNHS service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run CNHS service", "Running Failed:", false);
		}
	}
	...
	public void validateInDatabase() throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCNHS")[1],  this.CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0 );
		
		if(queryResultSet.next()){
			Reporter.logEvent(Status.PASS, "Validating Records exists for Account Transaction", "Records exists for Account Transaction\nTable Name: IND_SNAP_ACCT_BAL_ACTY and INDIVIDUAL", false);
