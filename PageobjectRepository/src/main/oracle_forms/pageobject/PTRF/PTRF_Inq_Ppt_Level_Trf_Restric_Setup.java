...
public class PTRF_Inq_Ppt_Level_Trf_Restric_Setup {

	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/PTRF_Inquire_Participant_Level_Trf_Restriction_Setup";
	...
	public void setServiceParameters()	
	{
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for PTRF service", this.queryString.replaceAll("&", "\n"), false);
	}
	...
	public void runService() throws SQLException {
		...
		//		System.out.println(serviceURL);
				...
				Reporter.logEvent(Status.PASS, "Run PTRF service", "Execution Done!", false);
			} catch (Exception e) {
				e.printStackTrace();
				Globals.exception = e;
				Reporter.logEvent(Status.FAIL, "Run PTRF service", "Running Failed:", false);
			}			
	}
	...
	public void validateOutput() throws SQLException
	{
		...
		if (Error.isEmpty()){
			...
			Reporter.logEvent(Status.INFO, "Values From Response: ", "PLAN NAME: "+ doc.getElementsByTagName("CONTROL_PLAN_NAME_0").item(0).getTextContent()+
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForPTRF")[1], ssn);
		if(DB.getRecordSetCount(queryResultSet)>0){
			...
			while(queryResultSet.next()){
				...
				Reporter.logEvent(Status.INFO, "Values from Database\nTable Name: TRF_RESTRC_PART_RULE", "EV_ID: "+queryResultSet.getString("EV_ID")+
					"\nIND_ID: "+queryResultSet.getString("IND_ID")+
					"\nGA_ID: "+queryResultSet.getString("GA_ID")+
					"\nRESTRC_TYPE_CODE: "+queryResultSet.getString("RESTRC_TYPE_CODE"), false);
			}			
		}
		else{
