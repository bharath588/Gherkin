...
public class RVMD_Multiple_Disbursement_Reversals_Executed_via_MAIN_MENU {
	...
	public void setServiceParameters() throws SQLException	
	{
		...
		this.setEVENT_LOV_X1(Stock.GetParameterValue("EVENT_LOV_X1"));
		this.setDSBA1_TEST_SUPPRESS_IND_0_X1(Stock.GetParameterValue("DSBA1_TEST_SUPPRESS_IND_0_X1"));
		this.setCORRECTION_QUES_CORRECTION_0_X1(Stock.GetParameterValue("CORRECTION_QUES_CORRECTION_0_X1"));
