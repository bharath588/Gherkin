...
public class PAGT_Query_Participant_Group_To_Group_Transfer {
	...
	public void setServiceParameters() {
		...
		Reporter.logEvent(Status.INFO, "Prepare test data for PAGT service",
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run PAGT service",
					"Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run PAGT service",
	...
	public void validateInDatabase() throws SQLException {
		...
		queryResultSet = DB.executeQuery(General.dbInstance,
				Stock.getTestQuery("queryForPAGT")[1]);
