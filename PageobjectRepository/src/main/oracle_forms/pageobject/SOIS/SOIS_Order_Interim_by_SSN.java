...
public class SOIS_Order_Interim_by_SSN {
	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/SOIS_Order_Interim_by_SSN_1";
	...
	String IND_HEADER_SELECT_IND_0;
	String IND_HEADER_SSN_0;
	...
	public void setIND_HEADER_SELECT_IND_0(String iND_HEADER_SELECT_IND_0) {
		IND_HEADER_SELECT_IND_0 = iND_HEADER_SELECT_IND_0;
	}
	public void setIND_HEADER_SSN_0(String iND_HEADER_SSN_0) {
		IND_HEADER_SSN_0 = iND_HEADER_SSN_0;
	}
	...
	public void setServiceParameters()
	{
		...
		this.setIND_HEADER_SELECT_IND_0(Stock.GetParameterValue("IND_HEADER_SELECT_IND_0"));
		this.setIND_HEADER_SSN_0(Stock.GetParameterValue("IND_HEADER_SSN_0"));
		...
		//		+"&IND_HEADER_SELECT_IND_0="+IND_HEADER_SELECT_IND_0+"&IND_HEADER_SSN_0="+IND_HEADER_SSN_0
		//		+"&PRT_SEL_DELIVERY_OPTION_EMAIL_0=" + PRT_SEL_DELIVERY_OPTION_EMAIL_0
				+"&numOfRowsInTable=20&json=false&handlePopups=false";		
		
		queryResultSetbeforeExe = DB.executeQuery(General.dbInstance, Stock.getTestQuery("querySOISbeforEXE")[1], this.GROUP_HEADER_GA_ID_0);
	...
	public void runService() {
		try {
			...
			Reporter.logEvent(Status.PASS, "Run SOIS_Order_Interim_by_SSN service", "Execution Done!", false);
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
			Reporter.logEvent(Status.FAIL, "Run SOIS_Order_Interim_by_SSN service", "Running Failed:", false);
		}
	}
	...
	/*		Reporter.logEvent(Status.INFO, "Values From RESPONSE: ", "GA_ID: " + doc.getElementsByTagName("GROUP_ACCOUNT_GA_ID_0").item(0).getTextContent()+
					...
					"\nDMTY_CODE: "+ doc.getElementsByTagName("IND_HDR_TOP_DMTY_CODE_0").item(0).getTextContent(), false);				
	*/	}else{
