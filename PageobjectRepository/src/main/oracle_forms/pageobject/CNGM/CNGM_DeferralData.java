...
public class CNGM_DeferralData {

	
	public String queryString;
	private String serviceURL =  "http://" + Stock.getConfigParam("TargetServiceHostServer").trim() + ":8080/ServiceManager/Macro/ExecMacro/CNGM_Validate_Conversion_Global_Mapping_Deferral_data";
	...
	public void setCHECKBOXES_DEFERRALS_0(String cHECKBOXES_DEFERRALS_0) {
		CHECKBOXES_DEFERRALS_0 = cHECKBOXES_DEFERRALS_0;
	}
	...
	public void setServiceParameters()	
	{
		...
		this.setCHECKBOXES_DEFERRALS_0(Stock.GetParameterValue("CHECKBOXES_DEFERRALS_0"));
		
		queryString = "?LOGON_USERNAME="+LOGON_USERNAME+"&LOGON_PASSWORD="+LOGON_PASSWORD+"&LOGON_DATABASE="+LOGON_DATABASE+"&CONTROL_SELECTION_0="+CONTROL_SELECTION_0+
				"&CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0="+CONVERSION_GROUP_ACCOUNT_SUBJECT_ID_0+"&CHECKBOXES_DEFERRALS_0="+CHECKBOXES_DEFERRALS_0+"&MO1_DISP_DFT_PRIN_CODE_0="+MO1_DISP_DFT_PRIN_CODE_0+
	...
	public void validateInDatabase()throws SQLException{
		...
		queryResultSet = DB.executeQuery(General.dbInstance, Stock.getTestQuery("queryForCNGMDef")[1]);
		if(DB.getRecordSetCount(queryResultSet)>0){
			...
			while(queryResultSet.next()){
				Reporter.logEvent(Status.INFO, "Values from Database",
						...
						"\nISIS_COL_NAME: "+queryResultSet.getString("ISIS_COLUMN_NAME"), false);
			}			
		}
		else{
