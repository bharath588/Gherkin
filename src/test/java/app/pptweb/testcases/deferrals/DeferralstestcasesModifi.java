...
public class DeferralstestcasesModifi {
	...
	public void SIT_PPTWEB_Deferral__AfterTax(int itr,
		...
		try {
			...
			deferrals.add_AutoIncrease(Stock.GetParameterValue("Add_auto_increase_type"));
	...
	public void SIT_PPTWEB_Deferral__Bonus(int itr, Map<String, String> testdata) {
		try {
			...
			deferrals.add_AutoIncrease(Stock
	...
	public void SIT_PPTWEB_Deferral_006_Previous_Contributions_Participant_hired_in_prior_year(
		...
		try {
			...
			TwoStepVerification mfaPage = new TwoStepVerification(login);
			LandingPage homePage = new LandingPage(mfaPage);
			if (homePage.getNoOfPlansFromDB(Stock
	...
	public void Deferrals_Participant_Prior_Contributions(int itr,
		...
		try {
			...
			if (Stock.GetParameterValue("Period_of_Participation")
				...
				priorContributions.verifyContributionMessage(Stock
				...
				if (priorContributions.verifyContributionMessage(Stock
						.GetParameterValue("yearToDateContribution"))) {
					Reporter.logEvent(
							Status.PASS,
	...
	public void Deferrals_Participant_Prior_Contributions7(int itr,
		...
		try {
			...
			priorContributions.enterContributionValue("CATCHUP CONTRIBUTION",
					Stock.GetParameterValue("catchupContribution"));
			Web.clickOnElement(priorContributions, "SAVE AND CLOSE");
		boolean updated=	priorContributions.verifyContributionMessage(Stock
		...
		try {
			...
			if(Stock.GetParameterValue("create_or_edit").equalsIgnoreCase("edit")){
				...
				*/
				...
				//add auto increase
				deferrals.add_AutoIncrease("Before Add Auto Increase");
				deferrals.add_AutoIncrease("Roth Add auto Increase");
				deferrals.add_AutoIncrease("After Add Auto Increase");
				deferrals.add_AutoIncrease("Catch Up Before Add Auto Increase");
				deferrals.add_AutoIncrease("Catch Up Roth Add Auto Increase");
				//deferrals.add_AutoIncrease("Roth Bonus Add Auto Increase");
				//deferrals.add_AutoIncrease("Before Bonus Add Auto Increase");
	...
	public void Deferral_030_Regular_BEFORE_Update_auto_increase_when_payroll_calendar_ADJRUNDATE(int itr,
		...
		try {
			...
			//Step 11 to 16
			deferrals.add_Auto_Increase_Date_DropDown(Stock
					.GetParameterValue("Add_auto_increase_BeforeTax"));
