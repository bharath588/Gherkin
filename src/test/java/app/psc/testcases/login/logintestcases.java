...
//			// page-GWRS
//
//			web.getWebInstance().get(Stock.GetParameterValue("ForceLoginTrueURL"));
...
//
//			web.getWebInstance().get(Stock.GetParameterValue("ForceLoginFalseURL"));
...
//			web.getWebInstance().get(Stock.GetParameterValue("ForceLoginDummyURL"));
//			isGWRSLogoDisplayed = Web.isWebElementDisplayed(login, "GWRS IMAGE");
//
//			if(isGWRSLogoDisplayed){
//				Reporter.logEvent(Status.PASS, "Check if GWRS Logo displayed",
...
//						"Login frame is not displayed",true);
//			}		
//			web.getWebInstance().get(Stock.getConfigParam("AppURL"+"_"+Stock.getConfigParam("TEST_ENV")));
//		} catch (Exception e) {
//			e.printStackTrace();
//			Globals.exception = e;
//			Reporter.logEvent(Status.FAIL, "A run time exception occured.", e.getCause().getMessage(), true);
...
////		web.getWebInstance().close();
////		web.getWebInstance().quit();
//	}
}
