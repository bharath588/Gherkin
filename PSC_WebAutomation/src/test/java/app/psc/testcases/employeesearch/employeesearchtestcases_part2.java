...
public class employeesearchtestcases_part2 {
	...
	public void TC001_Search_Employee_For_Valid_SSN(int itr,
		...
		try {
			...
			Reporter.logEvent(Status.INFO, "Testcase Description",
					"This testcase validates the search results for SSN input"
							+ ":" + "Positive flow", false);
	...
	public void TC003_Search_Employee_For_Valid_Name_Input(int itr,
		...
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
					"This testcase validates the search results for Name input"
							+ ":" + "Positive flow", false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This test case verifies the search results are not displayed for invalid
	 * Name input
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC005_Search_Employee_For_Valid_EmployeeID_Input(int itr,
		...
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
					"This testcase validates the search results for EmployeeID input"
							+ ":" + "Positive flow", false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This test case verifies the search results are not displayed for plans
	 * with divisions
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC07_Verify_employee_details_displayed_for_plans_with_divisions(
		...
		try {
			...
			Reporter.logEvent(
					...
					"This testcase validates the search results for plans having divisions",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	public void TC08_Verify_employee_details_displayed_for_valid_participant_id(
		...
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
					"This testcase validates the search results for ParticipantID input"
							+ ":" + "Positive flow", false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This testcase validates the search results for SSN Doesn't contain
	 * duplicate value
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC010_Verify_the_Search_results_for_SSN_doesnot_Contain_duplicate_Values(
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates the search results for SSN Doesn't contain duplicate values",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This testcase validates the search results for Name Doesn't contain
	 * duplicate value
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC011_Verify_the_Search_results_for_Name_doesnot_Contain_duplicate_Values(
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates the search results for Name Doesn't contain duplicate values",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This testcase validates the search results for EmployeeID Doesn't contain
	 * duplicate value
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC012_Verify_the_Search_results_for_EmployeeID_doesnot_Contain_duplicate_Values(
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates the search results for EmployeeID Doesn't contain duplicate values",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This testcase validates the search results for participant ID Doesn't
	...
	public void TC013_Verify_the_Search_results_for_pptID_doesnot_Contain_duplicate_Values(
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates the search results for pptID Doesn't contain duplicate values",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * This testcase validates the search results for plans with Division
	...
	public void TC014_Verify_the_Search_results_for_Plans_with_Div_doesnot_Contain_duplicate_Values(
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates the search results for plans with Division Doesn't contain duplicate values",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * <pre>
	 * This testcase validates the search results for Plans that are having single division
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC015_Check_For_Plans_With_one_division(int itr,
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates the search results for Plans that are having only one division",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * <pre>
	 * This testcase validates the search results for Plans that are having multiple division
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	/**
	 * <pre>
	 * This testcase validates general employment informations
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	 ...
	 * TC017_Employment_Info_Verification(int itr, Map<String, String> testdata)
	 * { try { Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
	 * Reporter.logEvent(Status.INFO, "Testcase Description",
	 * "This testcase validates general employment informations", false);
	 * employeesearch = new EmployeeSearch().get();
	 * CommonLib.switchToDefaultPlan(); employeesearch.navigateToEmployeeTab();
	 * employeesearch.searchEmployeeBySSN(employeesearch.getSSNFromDB());//need
	 * to fetch employee from database
	 * employeesearch.verifyEmploymentInfoANDLabels();
	 * employeesearch.updateEmploymentInfoModalWindow();
	 * 
	 * } catch (Exception e) { e.printStackTrace(); Globals.exception = e;
	 * String exceptionMessage = e.getMessage(); Reporter.logEvent(Status.FAIL,
	 * "A run time exception occured.", exceptionMessage, true); } catch (Error
	 * ae) { ae.printStackTrace(); Globals.error = ae; String errorMsg =
	 * ae.getMessage(); Reporter.logEvent(Status.FAIL,
	 * "Assertion Error Occured", errorMsg, true); } finally { try {
	 * Reporter.finalizeTCReport(); } catch (Exception e1) {
	 * e1.printStackTrace(); } } }
	 */

	/**
	 * <pre>
	 * This testcase validates general contact informations
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	/**
	 * <pre>
	 * This testcase validates beneficiary details with DB
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	/**
	 * <pre>
	 * This testcase to update salary details and validate with DB
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC021_Salary_View_And_Update(int itr,
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase updates the salary information of an employee.",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * <pre>
	 * This testcase to verify Paycheck contribution section of an employee
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC022_Paycheck_contribution_View(int itr,
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"This testcase validates Paycheck contribution section of an employee.",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	public void TC024_Verify_Employee_Overview_Screen_Elements(int itr,
		...
		try {
			...
			employeesearch = new EmployeeSearch().get();
			homePage = new HomePage();
			homePage.searchPlanWithIdOrName(employeesearch.findPlanForUser(
	...
	/**
	 * <pre>
	 * This testcase to verify Employee overview plan list view section
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	 */
	@Test(dataProvider = "setData")
	public void TC025_Verify_Employee_Overview_PlanList_Balance_Section(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
			...
			if (employeesearch.verifyViewPageForAPlanHavingBalance()) {
				...
				Reporter.logEvent(
						Status.INFO,
						"Check if balance is displayed for any of the plan for employee enrolled with more than one plan.",
						"Balance is not displayed for any of the plan", true);
			}
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
	...
	/**
	 * <pre>
	 * This test case verifies employee subset section and subset history section for employee who are assigned with plans with subset
	 * and employee with no subset section.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC027_Verify_Subset_History_Section(int itr,
		...
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
					"This testcase validates Subset section of employee.",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
			...
			if (employeesearch.isSubSetSectionDisplayed())
				Reporter.logEvent(
						Status.FAIL,
						"Check Employee subset information section is not displayed.",
						"Employee subset information is displayed.", true);
			else
				Reporter.logEvent(
						Status.PASS,
						"Check Employee subset information section is not displayed.",
						"Employee subset information is not displayed.", false);
	...
	/**
	 * <pre>
	 * This testcase validates employee switch functionality through recently viewed features.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	/**
	 * <pre>
	 * This testcase validates employee enrollment and eligibility edit and save,edit and cancel features.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
		...
		/*	Map<String, String> dbMap = employeesearch
			...
			if (dbMap.equals(uiMap))
				Reporter.logEvent(
						...
						"" + "DB data:" + dbMap + " and UI data:" + uiMap,
						false);
			else
				Reporter.logEvent(
						Status.FAIL,
	...
	/**
	 * <pre>
	 * This testcase validate Account balance section for a Participant.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	 */
	@Test(dataProvider = "setData")
	public void TC30_Account_balance_Tab(int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"The objective of this test case is to validate Account balance section for a Participant.",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
			employeesearch = new EmployeeSearch().get();
			resultset = employeesearch.selectEmployeesForUser(
					Stock.getTestQuery("getPartWithAccountBalance"),
					Stock.GetParameterValue("username"));
			employeesearch.selectEmployeeFromResultSet(resultset);
			employeesearch.navigateToEmployeeOverViewPage();
			if (employeesearch.validateAccountBalanceScreen_0()) {
				...
				Reporter.logEvent(Status.INFO,
						"Check for participanct with account balance.",
						"No particiapnt is found" + " with account balance.",
						true);
			}
	...
	/**
	 * <pre>
	 * This testcase validates 'Data set error must be displayed if access to participant Web is disable via PSC'
	 *  and this test case also validates Employee Web button is not displayed if PSCPAE txn_code is not associated with logged in user.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC31_Disable_PAE_then_renable_PAE(int itr,
		...
		try {
			...
			if (employeesearch.validateEmployeeWebButton()) {
				Reporter.logEvent(
						Status.PASS,
						"Validate Employee Web bottin is displayed before deleting 'PSCPAE' txn_code for all user classes, logged in user is associated with.",
						"Employee web button is" + " displayed.", false);
			} else {
				Reporter.logEvent(
						Status.FAIL,
						"Validate Employee Web bottin is displayed before deleting 'PSCPAE' txn_code for all user classes, logged in user is associated with.",
						"Employee web button is" + " not displayed.", true);
			}
	...
	/**
	 * <pre>
	 * This test case validates the menu items for TRSFlex plan and for Non-TRSFlex plan.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC32_Supress_Menu_Items_for_TRS_Flex(int itr,
		...
		try {
			...
			employeesearch.selectPlanFromResultset(resultset);
			employeesearch.searchEmployeeByName("");
			employeesearch.navigateToEmployeeOverViewPage();// add TRS-Flex plan
			// employee to
			// recently viewed
			// list
			resultset = employeesearch.selectPlanForUser(
			...
			employeesearch.selectPlanFromResultset(resultset);
			employeesearch.searchEmployeeByName("");
			employeesearch.navigateToEmployeeOverViewPage();// add non TRS-Flex
			// plan employee to
			// recently viewed
			// list
	...
	/**
	 * <pre>
	 * This testcase validates Account detail and employee detail section's elements for TRSFlex and non TRSFlex plans.
	 * </pre>
	 * 
	 * @param itr
	 * @param testdata
	...
	public void TC33_Suppress_Account_Detail_elements_TRS_NonTRS(int itr,
		...
		try {
			...
			Reporter.logEvent(
					Status.INFO,
					"Testcase Description",
					"The objective of this test case is to validate account detail and employee detail elements for TRSFlex and non TRSFlex plans.",
					false);
			Reporter.logEvent(Status.INFO,
					"Test Data used for iteration" + itr,
					CommonLib.getIterationDataAsString(testdata), false);
	...
	/**
	 * <pre>
	 * 1.This test case validates the Investments sub section inside Account Detail tab(Columns).<br>
	 ...
	 * <pre></pre>
	 * 
	 * @Objective This test case validates the Statement tab and its filter
	 *            functionality.
	 * @param itr
	 * @param testdata
	 */
	 ...
	 * <pre></pre>
	 * 
	 * @Objective This test case validates the Enrollment & Eligibility section
	 *            is not displayed for NQ plans.
	 * @param itr
	 * @param testdata
	 */
	@Test(dataProvider = "setData")
	public void TC36_SIT_PSC_Employee_Overview_DB_plans_Enrollment_Elligibility_Not_displayed(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
	 ...
	 * <pre></pre>
	 * 
	 * @Objective This test case validates the new fields in Employment
	 *            Information section on Employee overview page.
	 * @param itr
	 * @param testdata
	 */
	/*
	 * @Test(dataProvider = "setData") public void
	 * TC37_SIT_PSC_Employment_Information_new_fileds(int itr, Map<String,
	 * String> testdata) { try { Reporter.initializeReportForTC(itr,
	 * Globals.GC_MANUAL_TC_NAME); Reporter.logEvent(Status.INFO,
	 * "Testcase Description","This test case validates" +
	 * " new fileds on Employment information section and validates their values against DB."
	 * , false); employeesearch = new EmployeeSearch().get(); resultset =
	 * DB.executeQuery
	 * (Stock.getTestQuery("getEmploymentPPT")[0],Stock.getTestQuery
	 * ("getEmploymentPPT")[1],""+ "K_"+Stock.GetParameterValue("username"));
	 * employeesearch.selectEmployeeFromResultSet(resultset);
	 * employeesearch.navigateToEmployeeOverViewPage();
	...
	/**
	 * <pre>
	 * This test case validates the tool-tip elements in recently viewed section.
	 * </pre>
	 * 
	 * @author smykjn
	 * @param itr
	 ...
	 * <pre></pre>
	 * 
	 * @Objective This test case validates the Fees detail on Employee overview
	 *            page.
	 * @param itr
	 * @param testdata
	 */
	...
	public void TC38_SIT_PSC_Accountdetail_Fees_Reg(int itr,
		...
		try {
			...
			/*
			 * resultset =
			 * DB.executeQuery(Stock.getTestQuery("getPastThreeMonthFeesData"
			 * )[0], Stock.getTestQuery("getPastThreeMonthFeesData")[1],""
			...
			resultset = DB.executeQuery(
					Stock.getTestQuery("getNoPastThreeMonthFees")[0],
					Stock.getTestQuery("getNoPastThreeMonthFees")[1], "K_"
							+ Stock.GetParameterValue("username"));
			employeesearch.selectEmployeeFromResultSet(resultset);
			employeesearch.navigateToEmployeeOverViewPage();
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to verify Employee Vesting information
	 * box displayed under Account detail tab with Vesting info.
	 * Note: This Test case deals with validation of elements inside vesting section.It does not validate data specific to a participant.
	 * </pre>
	 * @Objective This test case validates the Fees detail on Employee overview
	 *            page.
	 * @param itr
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to verify Employee Loan information
	 * box displayed under Account detail tab.
	 * Note: This Test case deals with validation of elements inside Loan section
	 * and navigation of loan pages when links are clicked.
	 * </pre>
	 * @Objective This test case validates the Loan detail on Employee overview
	 *            page.
	 * @param itr
	 * @param testdata
	 */
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to validate Employee YTD contributions sum displayed on YTD column,
	 * Paycheck contributions elements displayed in Paycheck contributions box under Account detail tab.
	 * </pre>
	 * @param itr
	 * @param testdata
	 */
	...
	public void TC41_SIT_PSC_Accountdetail_Paycheck_Contribution_YTD(int itr,
		...
		try {
			...
			employeesearch = new EmployeeSearch().get();
			/*
			 * employeesearch.selectEmployeesForUser(Stock.getTestQuery(
			 * "PaycheckContriSSNWithYTD"),
			 * Stock.GetParameterValue("username"));
			 */
			String ssn = Stock.GetParameterValue("SSN");
			employeesearch.searchEmployeeBySSNAllPlans(ssn);
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to validate page navigation of Paycheck contribution history window.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 11th-May-2017
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to validate remember employee search selection using browser cookie.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 11th-May-2017
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to validate fields with DB for enrollment and eligibility section.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 11th-May-2017
	...
	public void TC_44_Enroll_And_Eligibility_Fields_Type_Validations(int itr,
		...
		try {
			...
			employeesearch = new EmployeeSearch().get();
			resultset = DB.executeQuery(
					Stock.getTestQuery("getPPtWithEnrollAndEligDetails")[0],
					Stock.getTestQuery("getPPtWithEnrollAndEligDetails")[1],
					"K_" + Stock.GetParameterValue("username"));
	 ...
	 * 
	 *         <pre>
	 * The objective of this test case is to validate Add employee functionality for Autosite plan
	 * with participant enrolled into managed account.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 11th-May-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_45_SIT_PSC_Add_Employee_Autosite_Plan_Display_Angular_Page(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			employeesearch = new EmployeeSearch().get();
			/*
			 * resultset = employeesearch.selectPlanForUser(Stock.getTestQuery(
			 * "getAutoSuitePlan"),"" +Stock.GetParameterValue("username"));
			 */
	 ...
	 *         <pre>
	 * The objective of this test case is to validate Add employee functionality for Autosite plan
	 * without participant enrollment into managed account.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 11th-May-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_46_SIT_PSC_Add_Employee_Autosite_Plan_Display_Angular_Page(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_47_Search_Emp_Locked_Plan(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			Reporter.logEvent(Status.INFO,
					...
					CommonLib.getIterationDataAsString(testdata), false);
			employeesearch = new EmployeeSearch().get();
			employeesearch.searchEmployeeBySSNAllPlans(
					Stock.GetParameterValue("SSN"), false);
	 ...
	 * 
	 *         <pre>
	 * This test case validates employee info input fields in the process of adding new employee.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 5-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_51_Add_New_Employee_View_Page(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			String ga_id = "";
			resultset = DB.executeQuery(
					Stock.getTestQuery("IPBaddNewEmployeePreCondition")[0],
					Stock.getTestQuery("IPBaddNewEmployeePreCondition")[1],
					"K_" + Stock.GetParameterValue("username"));
			while (resultset.next()) {
	 ...
	 * 
	 *         <pre>
	 * This test case validates that user is taken to PPT Web for each plan employee is assigned with.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 5-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_50_SSN_Multiple_Plan_PAE(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
	 ...
	 * 
	 *         <pre>
	 * This test case validates message when there is no record in work_recently_viewed_part table.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 5-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_56_Info_Message_New_User(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			Reporter.logEvent(Status.INFO,
					...
					CommonLib.getIterationDataAsString(testdata), false);
			resultset = DB.executeQuery(
					Stock.getTestQuery("DeleteRecentlyViewedRecords")[0],
					Stock.getTestQuery("DeleteRecentlyViewedRecords")[1], "K_"
							+ Stock.GetParameterValue("username"));
			employeesearch = new EmployeeSearch().get();
	 ...
	 * 
	 *         <pre>
	 * This test case validates Employee active asset allocation screen.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 7-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_54_Employee_Overview_With_Active_Models(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			homePage = new HomePage();
			resultset = DB.executeQuery(
					Stock.getTestQuery("getPlanWithActiveAlloModel")[0],
					Stock.getTestQuery("getPlanWithActiveAlloModel")[1], "K_"
							+ Stock.GetParameterValue("username"));
			String plan = employeesearch.selectPlanFromResultset(resultset);
			resultset = DB.executeQuery(
					Stock.getTestQuery("getSSNforActiveAllocation")[0],
			...
			if (employeesearch.navigateToInvestmentTab()) {
				Reporter.logEvent(Status.PASS, "Navigate to investment tab.",
						"Investment tab is displayed.", false);
				employeesearch.validateAssetAllocationPage();
				employeesearch.addAllocationAndVerify();
			} else {
				Reporter.logEvent(Status.FAIL, "Navigate to investment tab.",
	 ...
	 * 
	 *         <pre>
	 * This test case validates employee ability to add/change allocation based on txn codes assigned/removed.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 7-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_53_Participant_Investments_Tab(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			resultset = DB.executeQuery(
					Stock.getTestQuery("checkESCPALTxnCode")[0],
					Stock.getTestQuery("checkESCPALTxnCode")[1], "" + "K_"
							+ Stock.GetParameterValue("username"));
			if (CommonLib.isTxnCodesPresent(resultset,
					Stock.GetParameterValue("TXN_CODE"))) {
				Reporter.logEvent(Status.INFO,
						"Check if user is assigned with ESCPAL txn code.",
						"User is assigned with ESCPAL" + " txn code.", false);
				ispresent = true;
			} else {
				Reporter.logEvent(
						Status.WARNING,
				...
				resultset = DB.executeQuery(
						...
						Stock.getTestQuery("checkESCPALTxnCode")[1], "" + "K_"
								+ Stock.GetParameterValue("username"));
				if (CommonLib.isTxnCodesPresent(resultset, Stock
						.GetParameterValue("TXN_CODE").split(","))) {
					Reporter.logEvent(
							Status.INFO,
							"insert txn code and Check again if user is assigned with ESCPAL txn code.",
							"User is assigned with ESCPAL" + " txn code.",
							false);
					ispresent = true;
				} else {
					ispresent = false;
			...
			employeesearch.get();
			resultset = DB.executeQuery(
					Stock.getTestQuery("getSSNForSelfDirectedAllocation")[0],
					Stock.getTestQuery("getSSNForSelfDirectedAllocation")[1],
	 ...
	 * 
	 *         <pre>
	 * This test case validates employee Transaction History page.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 10-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_48_AccountDetail_Transacion_History_Reg(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
			...
			employeesearch = new EmployeeSearch().get();
			resultset = DB.executeQuery(
					Stock.getTestQuery("getPPTWithTransactionHistory")[0],
					Stock.getTestQuery("getPPTWithTransactionHistory")[1], "K_"
							+ Stock.GetParameterValue("username"));
			employeesearch.selectEmployeeFromResultSet(resultset);
			employeesearch.navigateToEmployeeOverViewPage();
			...
			employeesearch.searchEmployeeBySSNAllPlans(Stock
					.GetParameterValue("SSN_NoPastThreeMonth"));
			employeesearch.navigateToEmployeeOverViewPage();
			CommonLib.switchToFrame(Web.returnElement(employeesearch, "FRAME"));
			String expNoDataMsg = Stock
					.GetParameterValue("ExpMsg_NoPastThreeMonth");
	 ...
	 * 
	 *         <pre>
	 * This test case validates external loan page elements and data.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 10-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_55_Loan_Summary_Table_External_Loan(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
			...
			employeesearch.searchByParticipantID(Stock
					.GetParameterValue("PPTId_NO_Loan_Amt"));
			employeesearch.navigateToEmployeeOverViewPage();
			employeesearch.noExtLoanDataValidation();
			employeesearch.returnToEmpOvwPage();
			employeesearch.searchByParticipantID(Stock
					.GetParameterValue("PPTId_NO_Loan"));
			employeesearch.navigateToEmployeeOverViewPage();
			CommonLib.switchToFrame(Web.returnElement(employeesearch, "FRAME"));
			String text = Web.returnElement(employeesearch,
					"NO LOANS PAYOUT ID").getText();
			if (Web.returnElement(employeesearch, "NO LOANS PAYOUT ID")
					.isDisplayed())
				Reporter.logEvent(
						Status.PASS,
			...
			employeesearch.returnToEmpOvwPage();
			employeesearch.searchByParticipantID(Stock
					.GetParameterValue("PPTId_NoLoanRepayments"));
			employeesearch.navigateToEmployeeOverViewPage();
	 ...
	 * 
	 *         <pre>
	 * This testcase will cover UI changes and work flow for Active employee.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 10-July-2017
	 */
	@Test(dataProvider = "setData")
	public void TC_56_PSC_Employee_Information_NonZeroDeferral_Terminated_GreaterThan_18Month(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			resultset = DB.executeQuery(
					Stock.getTestQuery("chkEmploymentAndEditTxnCode")[0],
					Stock.getTestQuery("chkEmploymentAndEditTxnCode")[1], "K_"
							+ Stock.GetParameterValue("username"));
			if (DB.getRecordSetCount(resultset) == 2) {
				resultset = DB.executeQuery(
						Stock.getTestQuery("getPlanWithEligiRuleSet")[0],
						Stock.getTestQuery("getPlanWithEligiRuleSet")[1], "K_"
								+ Stock.GetParameterValue("username"));
				...
				resultset = DB.executeQuery(
						Stock.getTestQuery("getSSNTermedGrtrThan18Months")[0],
						Stock.getTestQuery("getSSNTermedGrtrThan18Months")[1],
						planNumber);
				...
				while (resultset.next()) {
					...
					termDateModified = resultset
							.getString("EMP_TERMDATE_MODIFIEDDATE");
					break;
				}
				Date dbTermDate = CommonLib.getDateInDateFormatFromDateString(
						"MM/dd/yyyy", termDate);

				if (dbTermDate.after(CommonLib.getSysDateWithTimeZone("MST"))) {
					dateToRevertBack = CommonLib.getDateStringInDateFormat(
							"dd-MMM-yy", dbTermDate);
					System.out.println("TermDate from DB :" + dateToRevertBack);
					String modifyDate = CommonLib.getDate("dd-MMM-yy", -60);
					System.out.println("TermDate modified by -60 days :"
							+ modifyDate);
					DB.executeUpdate(
							Stock.getTestQuery("updateEmploymentTableTermDate")[0],
							Stock.getTestQuery("updateEmploymentTableTermDate")[1],
							modifyDate, ssn);
				}
				employeesearch = new EmployeeSearch().get();
				...
				if (employeesearch.employmentInfoSectionAndEditLinkValidation()) {
					...
					Web.clickOnElement(Web.returnElement(employeesearch,
							"CANCEL_BUTTON"));
	 ...
	 * 
	 *         <pre>
	 * This testcase covers hire date and term date validations for ppt whose termdate+18months<current date.
	 * </pre>
	 * @param itr
	 * @param testdata
	 * @Date 10-July-2017
	...
	public void TC_57_PSC_Employee_Information_NonZeroDeferral_TerminatedLessThen_18Month(
		...
		try {
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				...
				resultset = DB.executeQuery(
						Stock.getTestQuery("getSSNTermedLessThan18Months")[0],
						Stock.getTestQuery("getSSNTermedLessThan18Months")[1],
						planNumber);
				...
				if (dbTermDate.after(CommonLib.getSysDateWithTimeZone("MST"))) {
					...
					System.out.println("TermDate modified by -560 days :"
							+ modifyDate);
					DB.executeUpdate(
							Stock.getTestQuery("updateEmploymentTableTermDate")[0],
							Stock.getTestQuery("updateEmploymentTableTermDate")[1],
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_58_PSC_Employee_Information_RehireTerminate_NonZeroDeferral_Active(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(Status.INFO, "Testcase Description",
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				...
				resultset = DB.executeQuery(
						Stock.getTestQuery("getSSNWithNullTermDate")[0],
						Stock.getTestQuery("getSSNWithNullTermDate")[1],
						planNumber);
				...
				// Date dbTermDate =
				// CommonLib.getDateInDateFormatFromDateString("MM/dd/yyyy",
				// termDate);
				employeesearch = new EmployeeSearch().get();
				employeesearch.searchPlan(planNumber);
				employeesearch.searchEmployeeBySSN(ssn);
	...
	/**
	 * <pre>
	 * This test case aims to change hire info for active participant.
	 * </pre>
	 * 
	 * @author smykjn
	 * @param itr
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_60_PSC_Employee_Information_Active_ChageHireInfo(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				...
				if (employeesearch.employmentInfoSectionAndEditLinkValidation()) {
					...
					employeesearch.navigateToEmployeeOverViewPage();
					employeesearch.navigateToHirePageWhenEmpActiveNoTermDate();
					WebElement msgEle1 = Web.returnElement(employeesearch,
							"UPDATE_EMP_MSG_FOR_TEMRED_1");
					WebElement msgEle2 = Web.returnElement(employeesearch,
							"UPDATE_EMP_MSG_FOR_TEMRED_2");
					String msg = msgEle1.getText().trim() + " "
							+ msgEle2.getText().trim();
					if (Web.isWebElementDisplayed(msgEle1, false)
							&& Web.isWebElementDisplayed(msgEle2, false))
						Reporter.logEvent(
								Status.PASS,
	...
	/**
	 * <pre>
	 * This test case covers different scenario for Hire and terminate features for Zero deferral plan.
	 * </pre>
	 * 
	 * @author smykjn
	 * @param itr
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_59_PSC_Employee_Information_RehireTerminate_ZeroDeferral_Scenario1(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				resultset = DB
						.executeQuery(
								Stock.getTestQuery("getPlanWithEligiRuleAndZeroDeferral")[0],
								Stock.getTestQuery("getPlanWithEligiRuleAndZeroDeferral")[1],
								"K_" + Stock.GetParameterValue("username"));
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_59_PSC_Employee_Information_RehireTerminate_ZeroDeferral_Scenario2(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				resultset = DB
						.executeQuery(
								Stock.getTestQuery("getPlanAndZeroDeferralDaysRecord")[0],
								Stock.getTestQuery("getPlanAndZeroDeferralDaysRecord")[1],
								"K_" + Stock.GetParameterValue("username"));
				while (resultset.next()) {
					planNumber = resultset.getString("GA_ID");
					zero_after_x_days = resultset
							.getString("ZERO_AFTER_X_DAYS");
					break;
				}

				resultset = DB
						.executeQuery(
								Stock.getTestQuery("Xdays+TermDateLessThnSysdtWithZeroDeferral")[0],
								Stock.getTestQuery("Xdays+TermDateLessThnSysdtWithZeroDeferral")[1],
								planNumber, zero_after_x_days);
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_59_PSC_Employee_Information_RehireTerminate_ZeroDeferral_Scenario3(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				...
				resultset = DB
						.executeQuery(
								Stock.getTestQuery("Xdays+TermDateEqulsSysdtWithZeroDeferral")[0],
								Stock.getTestQuery("Xdays+TermDateEqulsSysdtWithZeroDeferral")[1],
								planNumber, zero_after_x_days);
				while (resultset.next()) {
				...
				if (indId.isEmpty()) {
					...
					String termDateString = employeesearch
							.getDateWithReferenceToAnyDate(new Date(),
									-Integer.parseInt(zero_after_x_days),
									"MM/dd/yyyy");
					employeesearch.searchEmployeeBySSNAllPlans(ssn);
					employeesearch.navigateToEmployeeOverViewPage();
					employeesearch.navigateToEmpDetailPage();
					employeesearch.navigateToHirePageWhenEmpActiveNoTermDate();
					employeesearch.terminateEmpWithCurrentDate(CommonLib
							.getDateInDateFormatFromDateString("MM/dd/yyyy",
									termDateString));
					resultset = DB
							.executeQuery(
									Stock.getTestQuery("Xdays+TermDateEqulsSysdtWithZeroDeferral")[0],
				...
				if (isIndIdEmpty) {
					employeesearch.rehireEmp(
							CommonLib.getDateStringInDateFormat("MM/dd/yyyy",
									new Date()), ssn);
				}
			}
		} catch (Exception e) {
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_59_PSC_Employee_Information_RehireTerminate_ZeroDeferral_Scenario4(
			int itr, Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			if (DB.getRecordSetCount(resultset) == 2) {
				...
				resultset = DB
						.executeQuery(
								Stock.getTestQuery("Xdays+TermDateGrtrThnSysdtWithNonZeroDeferral")[0],
								Stock.getTestQuery("Xdays+TermDateGrtrThnSysdtWithNonZeroDeferral")[1],
								planNumber, zero_after_x_days);
				while (resultset.next()) {
					indId = resultset.getString("IND_ID");
				}
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_61_SIT_PSC_Search_Employee_based_on_User_access(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME);
			Reporter.logEvent(
			...
			Reporter.logEvent(Status.INFO,
					...
					CommonLib.getIterationDataAsString(testdata), false);
			resultset = DB.executeQuery(
					Stock.getTestQuery("getNumberOfPlansQuery")[0],
					Stock.getTestQuery("getNumberOfPlansQuery")[1], "K_"
							+ Stock.GetParameterValue("username"));
			...
			resultset = DB
					.executeQuery(
							Stock.getTestQuery("queryToFindSSNforAplan")[0],
							Stock.getTestQuery("queryToFindSSNforAplan")[1],
							planNumber);
			while (resultset.next()) {
				ssn = resultset.getString("SSN");
				break;
	...
	/**
	 * <pre>
	 * To validate Stop all deferrals functionality
	 * </pre>
	 * 
	 * @author smykjn
	 * @param itr
	...
	public void TC_62_Stop_All_Deferrals(int itr, Map<String, String> testdata) {
		try {
			...
			resultset = DB
					.executeQuery(
							Stock.getTestQuery("getPPTAgeLessthnFiftyWithDeferrals")[0],
			...
			if (employeesearch.NavigateToDeferralPage()) {
				employeesearch.validateColumnsNameAndSSNOnDeferralPage(ssn,
						name);
				if (employeesearch.validateDeferralRecordFromDBForAnSSN(ssn))
					Reporter.logEvent(Status.PASS,
							"Validate deferral data from DB.", ""
				...
				String confirmationNumber = employeesearch
						.validateStopAllDeferralConfirmationScreen();
				...
				Reporter.logEvent(Status.FAIL, "Navigate to deferral page.",
						"Deferral page is not displayed.", false);
			}
	...
	/**
	 * <pre>
	 * To validate Agecatch up functionality
	 * </pre>
	 * 
	 * @author smykjn
	 * @param itr
	...
	public void TC_63_Agecatchup(int itr, Map<String, String> testdata) {
		try {
			...
			Reporter.logEvent(Status.INFO,
					...
					CommonLib.getIterationDataAsString(testdata), false);
			String ssn = "";
			List<String> expDeferralType = Arrays.asList(Stock
					.GetParameterValue("ExpectedDeferralTypes").split(","));
			if (Stock.GetParameterValue("IsAgeGtrThnFifty").equalsIgnoreCase(
					"No")) {
				resultset = DB
						.executeQuery(
								Stock.getTestQuery("getPPTAgeLessthnFiftyWithDeferrals")[0],
			...
			if (Stock.GetParameterValue("IsAgeGtrThnFifty").equalsIgnoreCase(
				...
				resultset = DB
						.executeQuery(
								Stock.getTestQuery("getPPTAgeGtrthnFiftyWithDeferrals")[0],
			...
			if (employeesearch.NavigateToDeferralPage()) {
				...
				if (Stock.GetParameterValue("IsAgeGtrThnFifty")
					...
					List<String> maxValues = Arrays.asList(Stock
							.GetParameterValue("MaxValue").split(","));
					if (employeesearch.validateAgecatchUpRule(expDeferralType
							.get(0))
							&& employeesearch
									.validateAgecatchUpRule(expDeferralType
			...
			employeesearch.returnToEmployeeOverview(Web.returnElement(
					employeesearch, "RETURN OVERVIEW PAGE"));
		} catch (Exception e) {
			e.printStackTrace();
			Globals.exception = e;
	...
	/**
	 * <pre>
	 * To validate Ongoing deferral changes - UI elements
	 * </pre>
	 * 
	 * @author smykjn
	 * @param itr
	 ...
	 */
	@Test(dataProvider = "setData")
	public void TC_64_OngoingDeferralUIValidation(int itr,
			Map<String, String> testdata) {
		try {
			Reporter.initializeReportForTC(itr, Globals.GC_MANUAL_TC_NAME,
					"DDTC-298");
			...
			if (itr == 2) {
				resultset = DB.executeQuery(
						Stock.getTestQuery("PPTWithNoDeferrals")[0],
			...
			if (itr == 1) {
				expDeferralTypeCode = Stock
						.GetParameterValue("DeferralTypeCode");
				if (employeesearch.validateDeferralRecordFromDBForAnSSN(ssn))
					Reporter.logEvent(Status.PASS,
							"Validate ongoing deferral from DB.", ""
									+ "Data is found in DB.", false);
				else
					Reporter.logEvent(Status.FAIL,
							"Validate ongoing deferral from DB.", ""
				...
				if (employeesearch.NavigateToDeferralPage("Ongoing")) {
					resultset = DB.executeQuery(
							Stock.getTestQuery("getPCT_AMT_Indicator")[0],
							Stock.getTestQuery("getPCT_AMT_Indicator")[1],
							planNumber, expDeferralTypeCode);
					employeesearch.amt_pct_buttonValidation(resultset);
					resultset.close();
					resultset = DB.executeQuery(
							Stock.getTestQuery("getDeferralInfoForAPlan")[0],
					...
					Reporter.logEvent(Status.FAIL,
							"Navigate to Ongoing deferral page.",
							"" + "Ongoing deferral page is not displayed.",
							false);
				}
			}
			if (itr == 2) {
				String expMessage = Stock.GetParameterValue("NoDeferralMsg");
				String actMessage = Web
						.returnElement(employeesearch, "NO_DEFERRAL_MESSAGE")
						.getText().trim();
